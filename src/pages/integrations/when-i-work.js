...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/when-i-work.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        When I Work Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(81, 163, 61, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">When I Work is the easiest way to schedule, manage attendance, and communicate with your staff from your Android device and PC. Notify your staff instantly about their work schedule via text, email, and web notifications.</p>
  ...
  <div>Creates an employee, manager, or supervisor.</div>
</div>
