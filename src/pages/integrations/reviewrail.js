...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/reviewrail.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ReviewRail Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 190, 250, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ReviewRail offers Small Businesses a way to automate the feedback request process with their customers. We invite happy customers to share ratings on review sites like Google and Facebook for your business.</p>
  ...
  <div>Creates a customer in ReviewRail to begin the Feedback followup process.</div>
</div>
