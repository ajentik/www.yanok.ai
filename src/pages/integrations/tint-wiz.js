...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tint-wiz.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Tint Wiz Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(109, 92, 174, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Tint Wiz is an all-in-one CRM app for window tinters</p>
