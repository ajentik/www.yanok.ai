...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/horoshop.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Horoshop Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(10, 136, 224, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Horoshop is an E-commerce platform that lets you to create powerful Online shops within a week.</p>
  ...
  <div>Triggers when a new user is registered on the website.</div>
</div>
