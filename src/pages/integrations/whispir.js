...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/whispir.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Whispir Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Bring together your SMS, voice messaging, email, social and more to communicate with your audiences from a single platform.</p>
