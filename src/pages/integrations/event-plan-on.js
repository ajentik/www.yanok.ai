...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/event-plan-on.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Event Plan On Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 255, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Event Plan On is a event management tool to organize events and keep event details on track.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Planningsheet</div>
  <div>Triggers when there\'s a new planning sheet item.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Task</div>
  <div>Triggers when there\'s a new task.</div>
</div>
