...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smartcat.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Smartcat Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(126, 100, 189, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Smartcat is an all-in-one platform connecting businesses and translators into a continuous translation delivery loop by combining a collaborative workflow solution, a marketplace, and a network of translation professionals.</p>
  ...
  <div>Triggers when the status of a project changes to completed.</div>
</div>
  ...
  <div>Creates a new Export(should be work with completed project trigger)</div>
</div>
