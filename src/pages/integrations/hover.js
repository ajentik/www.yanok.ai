...
export default function Page() {
  return (
    <IntegrationLayout 
      title="HOVER"
      description="HOVER uses ground-level photography to create an accurate 3D model and measurements of any property."
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>HOVER</title>
          <meta name="description" content="HOVER uses ground-level photography to create an accurate 3D model and measurements of any property." />
        </>
      ),
    },
  };
