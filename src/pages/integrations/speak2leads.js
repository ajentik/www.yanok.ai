...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/speak2leads.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Speak2Leads Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(190, 224, 233, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Speak2Leads converts your new inbound leads into phone calls to your reps to help them respond quickly and persistently and make more sales.</p>
