...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/clg-app.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CLG App Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(37, 59, 128, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">CLG App is a cloud-based software and CRM for the credit repair industry designed for credit consultants and starting a credit repair business.</p>
