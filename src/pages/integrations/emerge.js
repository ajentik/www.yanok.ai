...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/emerge.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">eMerge is a marketing automation technology and marketing services provider to the real estate industry.</p>
