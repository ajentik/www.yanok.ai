...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/katana-mrp.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Katana Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(79, 177, 246, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Katana gives thousands of manufacturers a live look at their business. Manage all the moving parts of your business and unite the apps and services you use in one visual platform.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Find a customer by name, email, or phone number</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Customer</div>
  <div>Find an existing customer, or create a new customer if one is not found.</div>
</div>
