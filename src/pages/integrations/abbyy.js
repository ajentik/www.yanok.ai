...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/abbyy.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">ABBYY provides document conversion, optical character recognition, data capture, and linguistic software and services.</p>
