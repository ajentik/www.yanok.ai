...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/protonmail.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Protonmail Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(138, 144, 199, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ProtonMail is an end-to-end encrypted email service. ProtonMail uses client-side encryption to protect email contents and user data before they are sent to ProtonMail servers.</p>
