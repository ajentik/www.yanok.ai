...
export default function Page() {
  ...
  <div>Triggers when there is new activity.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Feature</div>
  <div>Triggers when a feature is sent to Zapier by a user in Aha!</div>
</div>
  ...
  <div>Creates a new feature for a release.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Idea</div>
  <div>Creates a new idea.</div>
</div>
