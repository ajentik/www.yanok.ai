...
export default function Page() {
  return (
    <IntegrationLayout 
      title="RentCheck"
      description={`RentCheck is a property management tool that enables a transparent renting experience between Renters and Property Managers through easy to use and comprehensive property inspections.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`RentCheck is a property management tool that enables a transparent renting experience between Renters and Property Managers through easy to use and comprehensive property inspections.`} />
        </>
      ),
    },
  };
