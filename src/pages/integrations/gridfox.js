...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/gridfox.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Gridfox Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(72, 123, 237, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Manage your work, your way with Gridfox. The tool for team collaboration that helps you build custom applications in minutes.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Record Created or Updated</div>
