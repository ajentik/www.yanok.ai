...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zillow.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Zillow Tech Connect Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 116, 228, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The Zillow Tech Connect app allows agents to send leads to tools like CRMs and marketing automation software. It works for Zillow, Trulia, HotPads, RealEstate.com, and StreetEasy. It is also known as Zillow Premier Agent.</p>
  ...
  <div>Triggers when a new contact is available in your agent hub (does not trigger if an agent adds the contact themselves).</div>
</div>
