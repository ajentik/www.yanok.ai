...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/amped.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Amped Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(90, 206, 228, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Amped is an intelligent sales automation tool that enhances productivity, streamlines process, and empowers your sales teams to close more and increase retention.</p>
