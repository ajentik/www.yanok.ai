...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/workzone.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Workzone Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(34, 150, 225, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Workzone is project management software with a careful balance of functionality and ease-of-use to make it useful and accessible to diverse teams.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new time entry is added to a project.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Submit a Project Request</div>
  <div>Submits a new project request.</div>
</div>
