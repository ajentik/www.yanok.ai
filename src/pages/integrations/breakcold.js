...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/breakcold.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Breakcold Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 112, 243, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Breakcold is a social selling and sales engagement platform. Engage and contact prospects via LinkedIn, Twitter & Email, from one place.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a lead to Breakcold.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create List</div>
  <div>Creates a list to Breakcold.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Pause Campaign</div>
  <div>Pause a running campaign.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for lead in Breakcold.</div>
</div>
