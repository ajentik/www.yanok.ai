...
export default function Page() {
  return (
    <IntegrationLayout 
      title="SiteFotos"
      description="SiteFotos is a simple photo-taking, project-tagging, site mapping, (even time-tracking), customer communication portal."
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content="SiteFotos is a simple photo-taking, project-tagging, site mapping, (even time-tracking), customer communication portal." />
        </>
      ),
    },
  };
