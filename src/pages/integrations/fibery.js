...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Fibery"
      description="Fibery is the first work management software that fits and grows with your company."
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Fibery</title>
          <meta name="description" content="Fibery is the first work management software that fits and grows with your company." />
        </>
      ),
    },
  };
