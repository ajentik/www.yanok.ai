...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/super-dispatch.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Super Dispatch Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(254, 74, 73, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Super Dispatch platform is a better and a faster way to move cars for Carriers, Brokers, and Shippers.</p>
  ...
  <div>Triggers when order\'s status is changed to "delivered".</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an order is accepted by a carrier.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Order Picked Up</div>
  <div>Triggers when order\'s status is changed to "picked up".</div>
</div>
