...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/b2bbricks.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        B2BBricks Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(100, 149, 237, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Real Estate Software for individual and enterprise level realtors which will help you to provide real estate services in more efficiently and effectively than ever before</p>
  ...
  <div>Capture response from any classified</div>
</div>
