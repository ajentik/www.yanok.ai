...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/better-proposals.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Better Proposals Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(33, 37, 47, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Better Proposals is a simple, web-based proposal creation tool that lets you send professionally designed proposals.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Proposal Opened</div>
  <div>Triggers when a proposal is opened.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Proposal Paid</div>
  <div>Triggers when a proposal is paid.</div>
</div>
