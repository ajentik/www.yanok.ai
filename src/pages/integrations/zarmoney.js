...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zarmoney.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ZarMoney Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(6, 147, 195, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ZarMoney is a complete cloud accounting platform that offers invoicing, billing, income, and expense tracking, financial reporting, inventory management, and much more.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Delete Vendor</div>
  <div>Triggers when a vendor is deleted.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new item is added.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Delete Item</div>
  <div>Delete an Item.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Delete Vendor</div>
  <div>Delete a vendor.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an expense by id.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Item</div>
  <div>Finds an item by name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Vendor</div>
  <div>Finds a vendor by name.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Expense</div>
  <div>Finds an expense by id.</div>
</div>
