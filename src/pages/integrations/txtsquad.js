...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/txtsquad.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TxtSquad Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(3, 31, 83, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TxtSquad helps organizations with personalized, real time communications. Adding texting to your engagement toolbox.</p>
