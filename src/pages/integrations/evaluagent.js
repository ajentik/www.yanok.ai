...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/evaluagent.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        EvaluAgent Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(18, 116, 211, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">EvaluAgent provides everything you need to evaluate, coach and engage agents. This app allows you to view zendesk tickets that have been evaluated inside evaluation and have instant access to the results</p>
  ...
  <div class="font-semibold">Import a Contact</div>
  <div>Imports a contact record into EvaluAgent.</div>
</div>
