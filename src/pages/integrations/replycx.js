...
export default function Page() {
  return (
    <IntegrationLayout 
      title="ReplyCX"
      description={`It's easy to build bots, but hard to get the desired results. This is where ReplyCX steps in, providing a done-for-you service. We build a pipeline of qualified leads, automate your support, without increasing headcount with our no-code chatbot platform.`}
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>ReplyCX</title>
          <meta name="description" content={`It's easy to build bots, but hard to get the desired results. This is where ReplyCX steps in, providing a done-for-you service. We build a pipeline of qualified leads, automate your support, without increasing headcount with our no-code chatbot platform.`} />
        </>
      ),
    },
  };
