...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/changetower.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ChangeTower Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(68, 193, 170, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ChangeTower is a website monitoring and archiving platform that detects and tracks critical changes and sends you detailed alerts. Monitor for visual, content and code changes. Stay effortlessly informed about about updates that matter to you across the web.</p>
