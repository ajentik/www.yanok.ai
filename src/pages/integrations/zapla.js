...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zapla.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Accept bookings directly on your website with the Zapla embeddable booking widget. Installs with one line of code on any site.</p>
