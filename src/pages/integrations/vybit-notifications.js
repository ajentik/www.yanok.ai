...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vybit-notifications.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Vybit Notifications Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 140, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Vybit sends distinct, personalized sound notifications that you create by recording your own sounds or choosing from thousands of available sounds. With Vybit, you can create the sounds you like so you know exactly what each notification means to you.</p>
  ...
  <div class="font-semibold">Send Vyb</div>
  <div>Sends the Specified Vyb.</div>
</div>
