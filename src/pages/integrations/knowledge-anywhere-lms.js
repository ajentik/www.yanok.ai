...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/knowledge-anywhere-lms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Knowledge Anywhere LMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 186, 209, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Knowledge Anywhere\'s LMS helps connect your learners to Just in Time Training.</p>
  ...
  <div>Creates a User in the LMS</div>
</div>
