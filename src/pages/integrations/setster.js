...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/setster.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Setster Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(204, 0, 51, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Setster is an online appointment scheduling software built for complex enterprise booking needs, yet simple enough to use by smaller teams.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a busy time entry within Setster calendar.</div>
</div>
