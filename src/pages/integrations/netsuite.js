...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/netsuite.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">NetSuite offers a range of cloud based software solutions that include customer service management, enterprise resource planning and more.</p>
