...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Toggl"
      description="One of the simplest ways to keep track of your time."
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/toggl.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Toggl Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(221, 111, 209, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">One of the simplest ways to keep track of your time.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new projects are added.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Tag</div>
  <div>Triggers when new tags are created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Task</div>
  <div>Triggers when new tasks are added.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Time Entry Started</div>
  <div>Triggers when a new time entry is started and running.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Start Time Entry</div>
  <div>Starts a new time entry.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Stop Time Entry</div>
  <div>Stops an existing time entry.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a time entry by description.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Client</div>
  <div>Finds or creates a specific client.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds or creates a specific task.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Time Entry</div>
  <div>Finds or creates a specific time entry.</div>
</div>
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Toggl</title>
          <meta name="description" content="One of the simplest ways to keep track of your time." />
        </>
      ),
    },
  };
