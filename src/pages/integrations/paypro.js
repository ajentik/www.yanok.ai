...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/paypro.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        PayPro Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(2, 66, 92, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">PayPro is a payment service provider combined with affiliate marketing services. We make it as easy as possible to sell your products.</p>
