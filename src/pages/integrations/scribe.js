...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/scribe.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Scribe lets you convert all your favorite apps into completely customizable Slack Bots, within 5 minutes.</p>
