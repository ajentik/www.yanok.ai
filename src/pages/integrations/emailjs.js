...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/emailjs.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Send email directly from your client-side Javascript code – no server side code required.</p>
