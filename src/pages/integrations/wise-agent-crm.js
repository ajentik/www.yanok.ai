...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/wise-agent-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Wise Agent CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(12, 86, 187, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Wise Agent CRM helps Realtor\'s become pros by automating their leads, responses, appointments, and transactions.</p>
