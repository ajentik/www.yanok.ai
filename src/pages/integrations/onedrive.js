...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/onedrive.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        OneDrive Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(9, 74, 178, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">OneDrive, Microsoft\'s file sync app formerly known as SkyDrive, lets you store your files online, edit Office documents in the free Office Web Apps, and easily access your online files from your PC.</p>
  ...
  <div>Triggers when a new file is added in a folder.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Upload an existing file or attachment not bigger than 60 MB.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a file by name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Folder</div>
  <div>Finds a folder by name.</div>
</div>
