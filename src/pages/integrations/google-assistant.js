...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/google-assistant.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Google Assistant is an artificial intelligence-powered virtual assistant developed by Google. You can use this Google Assistant integration to manage information in other apps using simple voice commands.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Pushed Voice Message</div>
  <div>Triggers when invoked via Google Assistant</div>
</div>
