...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/propet.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">ProPet Software is full-service kennel software that streamlines the day-to-day operations of a dog boarding kennel, daycare, training and/or grooming business.</p>
