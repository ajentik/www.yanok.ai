...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zerobounce.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ZeroBounce Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 9, 35, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ZeroBounce is an email validation service. By removing bounces and spam traps, we help businesses across the globe reach humans, not bots.</p>
