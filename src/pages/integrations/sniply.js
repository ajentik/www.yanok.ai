...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sniply.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Sniply Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(1, 169, 224, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Sniply is the only link shortener that drives conversion. Convert your followers into users and customers. Embed Call-to-Actions into every page you share. Display your message on Forbes, TechCrunch, Mashable, Fast Company, BuzzFeed, anywhere. For free.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Form Submission Received</div>
  <div>Triggers when a new form submission is received.</div>
</div>
