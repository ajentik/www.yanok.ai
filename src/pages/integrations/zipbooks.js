...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zipbooks.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">ZipBooks is free accounting software that sends invoices, tracks time and expenses, integrates with your bank & lets you process credit cards.</p>
