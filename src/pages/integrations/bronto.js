...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bronto.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Bronto Software provides a cloud-based marketing platform that enables retailers to drive revenue via email, mobile and social campaigns.</p>
