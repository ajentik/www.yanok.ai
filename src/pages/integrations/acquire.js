...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/acquire.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Acquire (Legacy) Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 102, 249, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Acquire is a customer communication platform. We help users bridge gaps between customers and sales and support teams to empower all involved.</p>
  ...
  <div>Triggers when an agent ends a chat with a visitor.</div>
</div>
