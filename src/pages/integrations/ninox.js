...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/ninox.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Ninox Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(53, 138, 250, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Ninox is a low code database that empowers your team to quickly build custom business applications.</p>
  ...
  <div>Triggers when a new record is added to a table.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Record</div>
  <div>Triggers when a record is updated in a table.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Uploads file to a record.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Record</div>
  <div>Finds an existing record in a table.</div>
</div>
