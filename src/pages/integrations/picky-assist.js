...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/picky-assist.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Picky Assist Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Picky Assist helps to connect your existing android mobile phone as a gateway to automate SMS & WhatsApp or Business can connect Official WhatsApp Business Account to interconnect with other apps</p>
  ...
  <div>Triggers when there\'s a new WhatsApp/ SMS.</div>
</div>
  ...
  <div>Send A New WhatsApp / SMS.</div>
</div>
