...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/yapla.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Yapla Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 123, 20, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Yapla is a payment and an all-in-one management platform designed by and for non-profit organizations.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Subscription to an Event</div>
  <div>Triggers when a new subscription is added to a given event.</div>
</div>
