...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/subitup.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">SubItUp is an employee management solution designed to streamline staff scheduling, timekeeping, attendance tracking and more.</p>
