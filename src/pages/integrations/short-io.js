...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Short.io"
      description={`Short.io is a white label link shortener, which allows you to create short links on your own domain.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Short.io is a white label link shortener, which allows you to create short links on your own domain.`} />
        </>
      ),
    },
  };
