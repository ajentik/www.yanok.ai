...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/self-book.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CR Self Booking Reminder Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(84, 201, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">CR Self Booking Reminder is part of the Contact Reach software.</p>
