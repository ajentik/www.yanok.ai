...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/robly.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Robly is an email marketing solution designed for beginners and experts alike.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggered when a new contact is added.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds an existing contact to a list.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Removes a Contact from List.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Update Full Contact Details</div>
  <div>Update Full Contact Details – including Sub Lists.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contact</div>
  <div>Search for a contact by email.</div>
</div>
