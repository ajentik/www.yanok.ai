...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/move.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Move, Inc. is a real estate listing company based in Santa Clara, California.</p>
