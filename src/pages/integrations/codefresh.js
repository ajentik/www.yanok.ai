...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/codefresh.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Codefresh is a continuous delivery and collaboration platform for Docker. Codefresh helps teams improve quality and increase speed-to-market by facilitating rapid feedback and testing cycles.</p>
