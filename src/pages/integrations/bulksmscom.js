...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bulksmscom.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        BulkSMS.com Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(244, 121, 32, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">BulkSMS.com is a leading SMS messaging service provider offering two-way SMS communication services straight from your internet enabled computer.</p>
  ...
  <div>Triggers when a new delivery report is available.</div>
</div>
