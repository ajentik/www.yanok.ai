...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/phone-validator.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Phone Validator Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 123, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Use the official API of the popular phone line-type identification website, phonevalidator.com. Determine if any North American-based phone number is a landline, cell, VOIP or toll-free.</p>
  ...
  <div>Determine the line-type of any North American phone number as cell phone, landline, VOIP or toll-free.</div>
</div>
