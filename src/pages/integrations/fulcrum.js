...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/fulcrum.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Fulcrum Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(240, 15, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Fulcrum is a mobile data collection tool that allows users to easily design custom forms and quickly conduct field data collection on Android and iOS. Fulcrum works in connected and disconnected environments.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new record is deleted.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Record Updated</div>
  <div>Triggers when a new record is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Record Create</div>
  <div>Creates a new Record.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Record Update</div>
  <div>Update a new Record.</div>
</div>
