...
export default function Page() {
  return (
    <IntegrationLayout 
      title="timetonic"
      description={`TimeTonic is a smart team communication & organisation solution for the best managers`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`TimeTonic is a smart team communication & organisation solution for the best managers`} />
        </>
      ),
    },
  };
