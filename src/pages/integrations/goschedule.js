...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/goschedule.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        GoSchedule Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 93, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">GoSchedule is the appointment scheduling SaaS Software for SMB and Enterprise Segment to schedule resources, book online appointments, accept payments online and seamlessly integrates with websites and apps with API first notion.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Latest Schedule</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Schedules new appointment.</div>
</div>
