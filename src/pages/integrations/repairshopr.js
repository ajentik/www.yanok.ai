...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/repairshopr.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        RepairShopr Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 153, 204, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">RepairShopr is a platform to manage a service or repair business with job tracking (ticketing) and an emphasis on great communication.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a Customer in your RepairShopr account.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Lead</div>
  <div>Creates a Lead in your RepairShopr account.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Ticket</div>
  <div>Creates a Ticket in your RepairShopr account.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Log Call</div>
  <div>Creates a Call Log in your RepairShopr account.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Ticket</div>
  <div>Updates a Ticket in your RepairShopr account.</div>
</div>
