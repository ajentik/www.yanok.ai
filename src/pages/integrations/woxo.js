...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/woxo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        WOXO Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 130, 249, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">WOXO is a platform that enables you to effortlessly create videos from spreadsheets and display social content with widgets to level up your marketing.</p>
  ...
  <div>Triggers when a new video is generated.</div>
</div>
