...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/namely.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Namely Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 115, 220, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Namely is an easy-to-use Human Resources software platform that integrates personnel info, payroll and benefits administration, and goal-setting/performance management into an intuitive user interface.</p>
