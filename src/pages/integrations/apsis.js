...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/apsis.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">From email marketing and e-commerce to lead generation, automation and profile-based marketing.</p>
