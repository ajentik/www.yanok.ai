...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/icapture.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        iCapture Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Application with business card capture, badge and bar/QR code scanning, kiosk capture, online/offline functionality, CSV data export, real-time reporting, branching, skip logic.</p>
