...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/idx-leads.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        IDX Leads Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(40, 58, 139, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">IDX Leads is a system for real estate lead capture. Leverage your MLS/IDX listings to collect qualified leads from high quality traffic.</p>
  ...
  <div>Creates a new lead in your IDX Broker account.</div>
</div>
