...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/jitbit-helpdesk.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Jitbit Helpdesk Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 78, 80, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">A great help desk app for small and medium sized companies. It has all the features you may need, while staying easy to use and very user friendly.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new ticket in your Helpdesk.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create a User</div>
  <div>Create a new user in your Jitbit Helpdesk.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Ticket</div>
  <div>Finds a Ticket by an ID or a search query</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find User</div>
  <div>Search for users in your helpdesk</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create a Ticket</div>
  <div>Finds a Ticket by an ID or a search query</div>
</div>
