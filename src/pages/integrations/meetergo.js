...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/meetergo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        meetergo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(251, 211, 141, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Meetergo is appointment scheduling software to help anyone quickly and easily schedule meetings with you from anywhere. Manage your appointments, join calls, and accept payments all in one place.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new employee joins your brand.</div>
</div>
