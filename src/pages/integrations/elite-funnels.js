...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/elite-funnels.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Elite Funnels Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(65, 120, 220, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Elite Funnels is a service that allows you to build awesome super fast funnels and websites</p>
  ...
  <div>Triggers when a new contact is created or existing contact, is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new product is created in your store.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a product is updated in your store.</div>
</div>
  ...
  <div>Create contact. If contact with the supplied email already exists, it will be updated.</div>
</div>
