...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/trackingtime.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TrackingTime Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(36, 41, 84, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Time Tracking app that helps to manage projects, track working times and measure productivity.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Project Closed</div>
  <div>Triggers when a proyect is closed.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Tasks Closed</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new type of service.</div>
</div>
