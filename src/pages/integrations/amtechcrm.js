...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/amtechcrm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        AmtechCRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 74, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Amtech CRM is for handling leads, products and invoices.</p>
  ...
  <div>This is used to create a lead</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Order</div>
  <div>Finds a Order Info</div>
</div>
