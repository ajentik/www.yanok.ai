...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bento.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Bento is an email marketing, tracking, and conversation platform. Powered by data, built for ecommerce and SaaS</p>
  ...
  <div>Adds a Tag to Subscriber</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Unique Event</div>
  <div>Creates a Unique Event</div>
</div>
