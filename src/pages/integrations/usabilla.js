...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/usabilla.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Headquartered in Amsterdam, Usabilla was founded in 2009 with the belief that continuous user feedback is the key to any successful website, product or service.</p>
