...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/gingr.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Gingr is easy-to-learn software for dog daycare, pet boarding kennel management, and dog grooming business.</p>
