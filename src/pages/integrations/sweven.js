...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sweven.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Sweven Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(13, 81, 171, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SWEVEN allows businesses to seamlessly connect and collaborate with your team. This multi-platform and cloud-based SaaS solution gives you the power to receive, manage, assign, track, and bill for work (or product) orders of any trade. With SWEVEN in your workflow, you can bring together clients, vendors, and field staff in one place.</p>
  ...
  <div>Triggers when new asset is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Client</div>
  <div>Triggers when new client is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new note is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Product</div>
  <div>Triggers when new product is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Project</div>
  <div>Triggers when new project is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Site</div>
  <div>Triggers when new site is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Sub Asset</div>
  <div>Triggers when new sub asset is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Sub Project</div>
  <div>Triggers when new sub project is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Ticket</div>
  <div>Triggers when new ticket is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new vendor is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Sub Asset</div>
  <div>Creates a new sub asset.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Sub Project</div>
  <div>Creates a new sub project.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for your ticket with ticket code</div>
</div>
