...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/lawcus.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Lawcus is a practice management tool that enables lawyers to organize matters and automate consistent processes to help deliver more with transparency and less effort.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Lead Moved to Stage</div>
  <div>Triggers when lead is moved between stages inside the same workflow.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Matter Moved to Stage</div>
  <div>Triggers when matter is moved between stages inside the same workflow.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when lead isconverted to the matter.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a new expense entry.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Lead (Person)</div>
  <div>Creates a new lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Lead (Company)</div>
  <div>Creates a new lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add Note to Matter</div>
  <div>Creates a new comment for an existing matter.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add Task to Matter</div>
  <div>Creates a new task for existing matter.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing matter.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Stage on a Workflow</div>
  <div>Finds a stage on a particular workflow by name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find User</div>
  <div>Finds a team member.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Workflow</div>
  <div>Finds a workflow in your Team by name.</div>
</div>
