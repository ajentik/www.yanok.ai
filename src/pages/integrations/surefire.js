...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/surefire.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Surefire CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 153, 46, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Surefire CRM is a multi-faceted mortgage industry CRM marketing platform that offers personalized database marketing with unique content.</p>
