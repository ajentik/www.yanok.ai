...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/onsip.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">OnSIP is a powerfully simple cloud phone system and CPaaS that starts with free.</p>
