...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/batchbook.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Batchbook Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 104, 179, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Batchbook is a social CRM. It has all the standard features of a CRM plus it can take in Twitter streams, Facebook updates, RSS feeds and more.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds a new company.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Person</div>
  <div>Adds a new person.</div>
</div>
