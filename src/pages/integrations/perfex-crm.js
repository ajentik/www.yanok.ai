...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/perfex-crm.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Perfex CRM is a Customer Relationship Management software designed for small businesses and freelancers.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new invoice in created.</div>
</div>
