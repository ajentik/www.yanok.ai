...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/upsales.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Upsales Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(195, 232, 232, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The revenue engine for fast-growing businesses. You need to move fast and sell more. You need a revenue engine with CRM and Marketing Automation that can handle it. Unite sales and marketing with one platform for the whole customer journey.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when contact added to segment.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Segment</div>
  <div>Triggers when a segment is created.</div>
</div>
  ...
  <div>Creates a new appointment on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Company</div>
  <div>Creates a new company on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Contact</div>
  <div>Creates a new contact on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Form Submit</div>
  <div>Submits data into a selected Upsales form.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Appointment</div>
  <div>Updates an appointment on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Company</div>
  <div>Updates a company on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Contact</div>
  <div>Updates a contact on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find a Company</div>
  <div>Search for company on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find a Contact</div>
  <div>Search for contact on Upsales.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create a Company</div>
  <div>Search for the company on Upsales, if not found, create it.</div>
</div>
