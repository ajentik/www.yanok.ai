...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sendgrid.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SendGrid Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(26, 130, 226, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SendGrid\'s cloud-based email infrastructure relieves businesses of the cost and complexity of maintaining custom email systems</p>
  ...
  <div>Send an email to one or more recipients.</div>
</div>
