...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sendmunk.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Sendmunk Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 175, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Sendmunk is an All-In-One Marketing Automation platform which includes: Email, Push & SMS.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Contact Completes an Automation Workflow</div>
  <div>Triggers when a contact completes an automation workflow.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Add a tag to a contact</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>remove a tag from a contact</div>
</div>
