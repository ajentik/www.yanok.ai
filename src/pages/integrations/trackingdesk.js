...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/trackingdesk.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Trackingdesk Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The most advanced traffic management platform for affiliate marketers and media buyers. Reach positive ROI faster with better tracking and control over your marketing campaigns.</p>
