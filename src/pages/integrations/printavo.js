...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/printavo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Printavo is a simple tool for print, embroidery, promotional, digital, large format and sign shops to manage their business.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Find Delivery Method</div>
  <div>Find an existing delivery method</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new invoice status is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Quote/Invoice</div>
  <div>Triggers when a new order is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Payment Term</div>
  <div>Triggers when a new payment term is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Quote/Invoice</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Quote/Invoice</div>
  <div>Creates a new quote/invoice.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Update Quote/Invoice Status</div>
  <div>Updates a quote/invoice status</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find Quote/Invoice</div>
  <div>Find an existing quote/invoice.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Quote/Invoice</div>
  <div>Find or Create Quote/Invoice</div>
</div>
