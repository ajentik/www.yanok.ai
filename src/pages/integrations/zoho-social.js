...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zoho-social.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">ZOHO Social is a smart tool that helps businesses grow their presence on the social media by reaching the right audience at the right time.</p>
