...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/getmyinvoices.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        GetMyInvoices Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(79, 168, 224, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">GetMyInvoices is a digital invoice management software that simplifies and speeds up preparatory accounting. The solution automatically retrieves invoices and other documents from thousands of sources (10,000 online portals, email postboxes, invoicing tools etc.)</p>
