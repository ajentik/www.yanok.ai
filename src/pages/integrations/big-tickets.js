...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/big-tickets.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Big Tickets Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Big Tickets is an online ticketing solution for events of all sizes. Big Tickets empowers event organizers to manage, execute, and grow their events.</p>
