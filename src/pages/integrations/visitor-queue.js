...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/visitor-queue.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Visitor Queue Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(231, 47, 53, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Visitor Queue is a B2B lead generation software that allows you to identify the businesses that have visited your website.</p>
