...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/silverpop.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Silverpop is a web based, on-demand digital marketing technology provider that brings marketing automation, mobile, email, social and more under one roof! Silverpop handles everything from lead nurturing to campaign automation.</p>
