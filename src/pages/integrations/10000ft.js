...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/10000ft.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        10,000ft Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">10,000ft Plans is a resource management and project planning tool to help companies manage their business, teams, and projects.</p>
  ...
  <div>Triggers when a new assignment is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Assignment Updated</div>
  <div>Triggers when an assignment is updated.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Project</div>
  <div>Triggers when a new project gets created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Project Updated</div>
  <div>Triggers when a project gets updated.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Time Entry Updated</div>
  <div>Triggers when a new time entry is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a new team member.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Update Time Entry</div>
  <div>Update a time entry.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update User</div>
  <div>Updates a team member.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Assignable by ID</div>
  <div>Finds an existing assignable by the assignable\'s ID.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Assignable by Name</div>
  <div>Finds an existing assignable by name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Project by ID</div>
  <div>Finds an existing project using the project\'s ID.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing user by their email.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find User by ID</div>
  <div>Finds an existing user by their ID.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find User by Name</div>
  <div>Finds an existing user by their name.</div>
</div>
