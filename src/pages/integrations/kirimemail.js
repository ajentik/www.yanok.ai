...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kirimemail.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Kirim.Email Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(58, 66, 97, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Kirim.Email is an email marketing solution for any size of business, currently operated in the Indonesian and ASEAN market. Send your newsletter easily with KIRIM.EMAIL.</p>
  ...
  <div>Add a new subscriber or update if exist.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Remove Subscriber</div>
  <div>Remove a subscriber.</div>
</div>
