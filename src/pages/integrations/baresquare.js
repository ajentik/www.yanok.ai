...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/baresquare.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Baresquare Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(28, 56, 107, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Baresquare connects with your current analytics platform to make sense of the trends in your data, surfacing micro insights that could lead to major opportunities. In a sea of data, get your bearings with Baresquare’s action-driven analytics.</p>
  ...
  <div>Triggers when a new ticket is created in Baresquare.</div>
</div>
  ...
  <div>Creates a new ticket in your Baresquare account.</div>
</div>
