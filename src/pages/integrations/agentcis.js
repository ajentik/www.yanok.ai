...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/agentcis.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Agentcis Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(3, 169, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Agentcis is a business management application for Education and Migration Agencies that goes beyond currently available CRM platforms.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Office Check-In</div>
  <div>Triggers when a new office check-in is added.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Update existing contact field.</div>
</div>
