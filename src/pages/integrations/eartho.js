...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Eartho"
      description={`Authenticate, verify, and charge users of any platform with one line of code.`}
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Eartho</title>
          <meta name="description" content={`Authenticate, verify, and charge users of any platform with one line of code.`} />
        </>
      ),
    },
  };
