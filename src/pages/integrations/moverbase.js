...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/moverbase.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Moverbase Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(41, 82, 109, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Moverbase is moving company software that manages the entire operations of a moving company. It is 100% cloud-based and works on any computer, tablet or mobile phone.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Add a new Client to your Moverbase account.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Lead</div>
  <div>Add a new Lead to your Moverbase account.</div>
</div>
