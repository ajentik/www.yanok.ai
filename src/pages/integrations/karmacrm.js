...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/karmacrm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        karmaCRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(6, 107, 178, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">KarmaCRM is a simple CRM that helps you nurture personalized relationships at scale by connecting your email, calendar and team to bring all your data into a single place.</p>
