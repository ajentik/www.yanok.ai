...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zuora.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Zuora is a world class subscription service management system used by hundreds of companies across the world.</p>
