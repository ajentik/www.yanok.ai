...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sap-business-one.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">SAP Business One is business management software designed for small and medium-sized enterprises.</p>
