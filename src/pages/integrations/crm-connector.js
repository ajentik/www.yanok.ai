...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/crm-connector.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CRM Connector Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(13, 15, 54, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">CRM Connector is a cloud based CRM and marketing automation platform offering robust automation and sales tools for small to medium sized businesses worldwide.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Broadcast</div>
  <div>Triggers when a new broadcast is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Company</div>
  <div>Triggers when a new company is created within a group.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New CRM Activity</div>
  <div>Triggers when a new CRM activity is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Activate Workflow</div>
  <div>Activates a workflow for a contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Company</div>
  <div>Creates a new company, updates an existing company if exists.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Contact</div>
  <div>Creates a new contact, updates an existing contact if exists.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create CRM Activity</div>
  <div>Creates a new CRM activity for a contact.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new opportunity for a contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Queue Mail</div>
  <div>Queues a broadcast email.</div>
</div>
