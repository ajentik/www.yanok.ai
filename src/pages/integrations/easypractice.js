...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/easypractice.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        EasyPractice Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(84, 137, 112, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">EasyPractice is a platform for therapists and clinicians which handles your calendar, SMS reminders, online booking, journals, invoicing, payments and so much more.</p>
