...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/doppler.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Doppler Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(253, 186, 25, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Doppler is an email marketing tool that allows you to reach your clients in a simple, fast and effective way.</p>
  ...
  <div>Adds or updates a subscriber.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing subscriber.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Add Subscriber</div>
  <div>Find or Add Subscriber</div>
</div>
