...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/allclients.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">AllClients customer database software built to give you the email marketing and CRM functionality you’ll need to successfully manage and grow your business.</p>
