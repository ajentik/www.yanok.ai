...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/deltek.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Deltek Vision is a cloud-based project-based solution for professional services firms that is available for cloud or on-premise deployment.</p>
