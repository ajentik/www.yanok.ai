...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sparkpost.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SparkPost Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(249, 99, 34, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SparkPost by Message Systems is the enterprise-grade, developer-friendly email delivery service. It puts the same deliverability, scalability and speed of the world’s leading email platform in the hands of developers at companies of all sizes in an easily accessible cloud solution.</p>
  ...
  <div>Sends an email with your SparkPost.com account. You\'ll need an API key with at least the "Transmissions: Read/Write" permission.</div>
</div>
