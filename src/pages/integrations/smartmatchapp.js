...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smartmatchapp.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SmartMatchApp Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(76, 130, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SmartMatchApp is a matchmaking and membership CRM to organize and optimize the process of matching, introducing, and connecting people.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New, Updated or Deleted Client</div>
  <div>Triggers when a client changed.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create or Update a client. Trying to find client by email.</div>
</div>
