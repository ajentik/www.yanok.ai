...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smartlook.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Smartlook Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(2, 49, 137, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Smartlook is the missing puzzle in analyzing user behavior. Get real qualitative information that helps you understand in-depth what\'s going on in your app and website.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new note or comment are created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Get Funnel</div>
  <div>Get a Funnel details</div>
</div>
