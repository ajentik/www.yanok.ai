...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/instagram-custom-audiences.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Instagram Custom Audiences Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Instagram Custom Audiences make signing up for business information easy for people and more valuable for businesses. The Instagram lead ads app is useful for marketers who want to automate actions on their leads.</p>
  ...
  <div class="font-semibold">Create Custom Audience</div>
  <div>Creates a new custom audience. Note: You may need to</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add Email to Custom Audience</div>
  <div>Adds an email address to an existing custom audience.</div>
</div>
