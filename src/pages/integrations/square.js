...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/square.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Square creates tools that help sellers of all sizes start, run and grow their businesses. Square’s point-of-sale service offers tools for every part of running a business, from accepting credit cards and tracking inventory to real-time analytics and invoicing.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new order is processed.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds a customer to a group.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Change Inventory</div>
  <div>Adjusts an inventory or changes its physical count.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new draft invoice for an order.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Paid Order</div>
  <div>Creates an externally paid and completed order.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Refund Payment</div>
  <div>Refunds a completed payment.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Remove Customer From Group</div>
  <div>Removes a customer from a group.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Send Invoice</div>
  <div>Sends an existing draft invoice.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a customer based on email, phone number, or reference ID.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an order based on customer, fulfillment status, or order state.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Customer</div>
  <div>Find a customer. Optionally, create one if none are found.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Order</div>
  <div>Find an order. Optionally, create one if none are found.</div>
</div>
