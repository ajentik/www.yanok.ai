...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/evoliz.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Evoliz Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(16, 119, 189, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Evoliz is an invoicing and management software designed for small businesses but also their accountants.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Advance</div>
  <div>Triggers when a new advance is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Bank Item</div>
  <div>Triggers when a new bank item is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Client Contact</div>
  <div>Triggers when a new client contact is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Credit</div>
  <div>Triggers when a new credit is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Invoice (Unpaid)</div>
  <div>Triggers when a new invoice\'s payment is late.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Sale Order</div>
  <div>Triggers when a new sale order is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a account</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Article</div>
  <div>Creates a Article</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Contact Client</div>
  <div>Creates a Contact Client</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Contact Prospect</div>
  <div>Creates a Contact Prospect</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a Payment to an Invoice.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Sale Order</div>
  <div>Creates a Sale Order</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Invoice Sale Order</div>
  <div>Invoices a Sale Order</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Save Invoice</div>
  <div>Saves an Invoice</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Send Invoice</div>
  <div>Sends an Invoice</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Article</div>
  <div>Finds an Article</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contact Client</div>
  <div>Finds a Contact Client</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a Quote by Document Number</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Sale Order</div>
  <div>Finds a Sale Order</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Contact Client</div>
  <div>Finds a Contact Client</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Sale Order</div>
  <div>Finds a Sale Order</div>
</div>
