...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/orangescrum.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Orangescrum Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 122, 89, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Orangescrum is a project management tool to organize tasks projects and users and keep everything on track.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a project on Orangescrum by zapier when other apps will create a new project zap.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Task</div>
  <div>When action new task hit , a task create on an Orangescrum.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create User</div>
  <div>New User create when action hit on an Orangescrum</div>
</div>
