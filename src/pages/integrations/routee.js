...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/routee.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Routee Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(29, 63, 227, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Routee is a platform that provides users with SMS sending functionality, enhancing communication between businesses and individuals.</p>
