...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/marketo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Marketo\'s marketing automation software helps marketers engage customers and prospects.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a lead whose e-mail address matches the search criteria.</div>
</div>
