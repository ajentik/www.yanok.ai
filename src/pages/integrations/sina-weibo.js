...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sina-weibo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Sina Weibo is a popular social and microblogging service in China.</p>
