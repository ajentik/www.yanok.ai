...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/officexlr.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Officexlr Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(15, 98, 254, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Officexlr is a low-code application development platform to create customized, secure & integrated business apps.</p>
