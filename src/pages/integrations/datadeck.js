...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/datadeck.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Datadeck Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(3, 169, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Datadeck is a data integration, visualization and collaboration tool that lets you get data from different sources all into one place and keep track of important metrics with ease.</p>
  ...
  <div class="font-semibold">Create Data Row</div>
  <div>Creates a new data row in Datadeck.</div>
</div>
