...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/textus.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">TextUs is the leading business-class text messaging platform built specifically for inside sales, recruiting and customer service teams.</p>
