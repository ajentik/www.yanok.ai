...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/intakeq.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">IntakeQ is a tool that sends private electronic intake forms to your clients. We are HIPAA compliant and support e-signatures.</p>
