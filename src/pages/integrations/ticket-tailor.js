...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/ticket-tailor.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Ticket Tailor Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 93, 153, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Ticket Tailor is an easy way to sell tickets online for events and attractions. We don\'t charge any per-ticket fees, and we let you integrate the booking process in to your website.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new order for tickets is created.</div>
</div>
