...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/alyce.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">A.I. platform for gifting superpowers to send the perfect 1-to-1 gift to engage your most important prospects, customers or employees.</p>
