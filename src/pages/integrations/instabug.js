...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/instabug.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Instabug is a software company that provides bug reporting, crash reporting, in-app chats, and user surveys for mobile apps.</p>
