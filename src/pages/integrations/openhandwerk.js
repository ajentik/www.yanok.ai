...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/openhandwerk.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        openHandwerk Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(59, 96, 122, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">openHandwerk is invoice & project management software which includes many features like CRM, DMS, Calendar & many more supporting the daily workflow as an artisan.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Calendar Category</div>
  <div>Triggers when a new calendar category is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Update an extising appointment</div>
</div>
