...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/chirpley.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Chirpley Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(53, 147, 208, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Chirpley is a SMS AI tool to create powerful productivity and text based applications.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New SMS Gateway</div>
  <div>Triggers when a new sms gateway is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Table</div>
  <div>Triggers when a new table is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a contact give name.</div>
</div>
