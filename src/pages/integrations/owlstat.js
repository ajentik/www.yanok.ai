...
export default function Page() {
  return (
    <IntegrationLayout 
      title="OwlStat"
      description="OwlStat is an Instagram analytics tool to check your accounts' insights and statistics"
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>OwlStat</title>
          <meta name="description" content="OwlStat is an Instagram analytics tool to check your accounts' insights and statistics" />
        </>
      ),
    },
  };
