...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/weebly.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Weebly is an easy to use way to make high-quality websites like blogs or online stores.</p>
