...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/offalerts.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        OffAlerts Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Uptime Monitors & Status Pages. Get Immediate Email, SMS and Push Notifications (Off Alerts) When Your Website Or App Is Offline.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Monitor Event</div>
  <div>Triggers when a new monitor event triggers.</div>
</div>
