...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smslink.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SMSLink Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 124, 165, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SMSLink is a SMS provider that provides integrated services such as SMS Marketing, SMS Gateway, Mail to SMS and SMS Alerts.</p>
