...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/keeping.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Keeping is a customer support help desk that integrates with Gmail.</p>
  ...
  <div>Triggers when agent is assigned to the ticket.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Agent Reply</div>
  <div>Triggers when agent replies to the ticket.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Customer Reply</div>
  <div>Triggers when customer replies to the ticket.</div>
</div>
