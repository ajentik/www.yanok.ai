...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/jama.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Jama Software is a leading product development platform provider for companies building complex products and integrated systems.</p>
