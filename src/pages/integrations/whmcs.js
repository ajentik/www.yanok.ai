...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/whmcs.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        WHMCS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(115, 203, 11, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">WHMCS is a complete client management package, supporting billing & support solutions for any online business.</p>
  ...
  <div>Triggers whenever a new todo item.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new ticket in WHMCS.</div>
</div>
