...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bigin.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Bigin by Zoho CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(35, 174, 115, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Bigin is a sales pipeline management software that lets you manage deals, track activities and keep all the interactions with your contacts at one place.</p>
  ...
  <div>Triggers when a new call is added.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new company or updates the details of the existing company.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Contact</div>
  <div>Creates a new contact or updates the details of the contact, if contact with the provided email address exists.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Deal</div>
  <div>Creates a new deal or updates the details of an existing deal.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates the details of an existing deal</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates a new task.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Company</div>
  <div>Searches an existing company.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Searches an existing deal.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Event</div>
  <div>Searches an existing event.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Product</div>
  <div>Searches an existing product.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Task</div>
  <div>Searches an existing task.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search User</div>
  <div>Searches an existing user.</div>
</div>
