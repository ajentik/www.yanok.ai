...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/izooto.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        iZooto Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(31, 54, 79, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">IZooto is a web push notification platform which enables website owners to re-engage and re-target visitors through web push notifications.</p>
  ...
  <div>Send a push notification to all subscribers.</div>
</div>
