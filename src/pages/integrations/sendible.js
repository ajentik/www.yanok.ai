...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sendible.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Sendible is an elegant software that provides social media management to businesses of all sizes across all industries.</p>
