...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/airfocus.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        airfocus Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(66, 174, 240, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Use airfocus to prioritize your projects and features to build more effective roadmaps. Get everyone aligned and the right stuff done.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new item is created or an already existing item is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create an item in airfocus.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Delete Item</div>
  <div>Delete an item in airfocus.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Item</div>
  <div>Update an item in airfocus.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Item</div>
  <div>List items in an airfocus workspace</div>
</div>
