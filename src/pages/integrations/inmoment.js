...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/inmoment.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">InMoment provides SaaS-based customer survey and enterprise feedback management solutions for data collection activities.</p>
