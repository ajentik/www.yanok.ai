...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/new-relic-insights.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        New Relic Insights Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(250, 73, 43, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">New Relic Insights is a real-time analytics platform that collects metrics directly from your live production software and transforms them into actionable insights about your business, customers, and applications.</p>
  ...
  <div>Create a new custom event inside New Relic Insights for tracking.</div>
</div>
