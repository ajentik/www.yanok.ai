...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/alloy-navigator-express.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Alloy Navigator Express is an IT Help Desk and Asset Management solution for small and medium business.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an Ticket is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Ticket activity</div>
  <div>Triggers when a new Activity is added to any Ticket.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Ticket status change</div>
  <div>Triggers when a status of an Ticket is changed.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for Change Request record by ID or OID.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for Person record by ID or OID.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Ticket</div>
  <div>Search for Ticket record by ID or OID.</div>
</div>
