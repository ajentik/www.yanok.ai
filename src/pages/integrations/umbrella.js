...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/umbrella.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Umbrella gives you the tools, training and support, to build and grow a digital marketing agency in partnership with known tech-brands.</p>
