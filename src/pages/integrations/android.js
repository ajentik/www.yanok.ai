...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/android.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Android is a mobile phone operating system used extensively by dozens of carriers. Zapier can make it easier than ever to leverage the hundreds of thousands of apps out there with Android.</p>
