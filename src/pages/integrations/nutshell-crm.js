...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Nutshell"
      description={`Nutshell is an affordable, easy-to-use CRM that helps small-business sales teams win more deals.`}
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/nutshell-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Nutshell Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(240, 84, 8, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Nutshell is an affordable, easy-to-use CRM that helps small-business sales teams win more deals.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new Company is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new Person is created.</div>
</div>
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Nutshell is an affordable, easy-to-use CRM that helps small-business sales teams win more deals.`} />
        </>
      ),
    },
  };
