...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/envoke.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Envoke Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(30, 52, 87, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Envoke is a broadcast email platform for compliance-conscious organizations sending opt-in and mandatory content with an emphasis on data security and subscription management.</p>
  ...
  <div>Trigger for all form submissions to Envoke.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Contact</div>
  <div>Trigger a new contact is added.</div>
</div>
