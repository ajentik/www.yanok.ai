...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/opsgenie.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        OpsGenie Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(4, 57, 192, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">OpsGenie extends IT Operations Management to mobile devices. OpsGenie gets alerts from IT management systems and notify the users via iPhone/Android push notifications, email, text messages and voice to text phone calls. OpsGenie automates the notification process, empowering users to receive alert notifications and rapidly respond to them directly from OpsGenie apps.</p>
  ...
  <div>Creates an alert at OpsGenie.</div>
</div>
