...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Zoho Sign"
      description="Zoho Sign is a complete digital signature app that allows you to securely sign, send, and manage business documents online. Build automated electronic signature workflows to close deals quickly."
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content="Zoho Sign is a complete digital signature app that allows you to securely sign, send, and manage business documents online. Build automated electronic signature workflows to close deals quickly." />
        </>
      ),
    },
  };
