...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Logisav"
      description="Logisav is a powerful enterprise software that helps your team being more productive."
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/logisav.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Logisav Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(39, 49, 113, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Logisav is a powerful enterprise software that helps your team being more productive.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Owner</div>
  <div>Triggers when a new owner is created.</div>
</div>
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Logisav</title>
          <meta name="description" content="Logisav is a powerful enterprise software that helps your team being more productive." />
        </>
      ),
    },
  };
