...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/universell.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Universell Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(230, 121, 45, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Scale your business faster, minus heavy resources. Fully managed tools & services helping you reach more customers, get paid easily, and scale & grow your business without any additional investment in staff and systems.</p>
  ...
  <div>Triggers when new lead added</div>
</div>
