...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/timetrade.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Intelligent online appointment scheduling by TimeTrade. Join the 500+ enterprises and 30k+ business that schedule appointments every day.</p>
