...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/boomset.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Boomset Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(28, 37, 48, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Boomset is an all-in-one platform to streamline your event management. Power events with features like online and onsite registration, self-check-in, facial recognition, on-demand printing, gamification, RFID tracking, lead retrieval and more.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Guest Registered</div>
  <div>Triggers when a new guest is created at an event.</div>
</div>
