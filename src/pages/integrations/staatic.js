...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/staatic.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Staatic Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(208, 91, 61, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Staatic allows you to generate and deploy an optimized static version of your WordPress site, improving performance, SEO and security all at the same time.</p>
  ...
  <div>Creates a form submission.</div>
</div>
