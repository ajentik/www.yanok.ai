...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/contactout.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Find anyone\'s personal email & phone number. Hire talent 10x faster with the most powerful sourcing platform available</p>
  ...
  <div>Triggers when a new lead was exported.</div>
</div>
