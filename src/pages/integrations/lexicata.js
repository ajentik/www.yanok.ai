...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/lexicata.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Lexicata is a law firm CRM and client intake software featuring a legal CRM, online intake forms, e-signature, referral tracking, and more.</p>
