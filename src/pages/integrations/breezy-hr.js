...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/breezy-hr.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Breezy HR Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(32, 143, 183, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">A uniquely simple, visual recruiting tool and applicant tracking system.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new candidate is added to an active position.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Active Position</div>
  <div>Triggers when a position is set active for the first time.</div>
</div>
