...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/muvi.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Muvi Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(12, 185, 242, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Muvi is a SaaS-based OTT Platform Provider that allows Content owners to launch Audio/Video Streaming Platforms (On Demand/Live) for Web/Mobile/TV.</p>
  ...
  <div>Triggers when a new registration is done.</div>
</div>
  ...
  <div>Creates a free registration in your store</div>
</div>
