...
export default function Page() {
  return (
    <IntegrationLayout 
      ...
      description={`Freshsales Classic is an online, cloud-based CRM with integrated phone and email, user behavior tracking, lead scoring and more.`}
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/freshsales.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Freshsales Classic Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 168, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Freshsales Classic is an online, cloud-based CRM with integrated phone and email, user behavior tracking, lead scoring and more.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Add Note to Sales Account</div>
  <div>Adds a note to a sales account.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates the existing contact or creates the new contact if contact doesn\'t exist</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Delete Contact</div>
  <div>Delete an existing contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Lead Convert</div>
  <div>Convert a Lead.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Find an existing account by name.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Find an existing lead by email.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search the matching Contacts</div>
  <div>Search the matching Contacts</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search the matching Leads</div>
  <div>Find an existing lead by email.</div>
</div>
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Freshsales Classic is an online, cloud-based CRM with integrated phone and email, user behavior tracking, lead scoring and more.`} />
        </>
      ),
    },
  };
