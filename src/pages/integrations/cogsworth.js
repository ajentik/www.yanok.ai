...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cogsworth.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Cogsworth Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(77, 154, 52, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Cogsworth is an appointment and meeting scheduling app that allows people to book in time with you and your business when you are available. Cogsworth syncs with your calendar and pulls out your availability and also pushes your bookings back to your calendar.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Cancelled Appointment</div>
  <div>Triggers when an appointment is cancelled.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Appointment Request</div>
  <div>Triggers when a new appointment is requested and is pending approval.</div>
</div>
