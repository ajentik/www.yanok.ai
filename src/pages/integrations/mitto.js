...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/mitto.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">The Mitto integration enables apps to send enterprise grade SMS. Use it to send alerts, reminders, invites, marketing messages or any other kind of short message. We provide you a fast and reliable service which also brings you high conversion rates!</p>
  ...
  <div>Enables you to send same SMS to several receivers.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Send SMS</div>
  <div>Enables you to send an SMS to a single recipient.</div>
</div>
