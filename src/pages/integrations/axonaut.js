...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/axonaut.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Axonaut Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 143, 196, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Axonaut is a CRM and more: follow your customer from before the first contact, beginning at the marketing campaign, though negotiations, billing, bank reconciliation.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Axonaut User</div>
  <div>Triggers when a new Axonaut user is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Closed Ticket</div>
...
<div class="flex flex-col items-start">
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Create Company and Employee</div>
  <div>Creates a new Company and its Employee</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Employee</div>
  <div>Creates an Employee into a Company</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates an Invoice Payment</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a prospect / customer</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contract</div>
  <div>Finds a Contract</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Quotation</div>
  <div>Finds a Quotation by ID</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Searches for a Company</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Employee</div>
  <div>Searches an Employee</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Employee or Create Company and Employee</div>
  <div>Searches an Employee</div>
</div>
