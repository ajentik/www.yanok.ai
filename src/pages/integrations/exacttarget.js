...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/exacttarget.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ExactTarget Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ExactTarget is a suite of marketing tools that helps marketers deliver email marketing, mobile marketing, and social media marketing in realtime across multiple channels to drive customer engagement, automate marketing, increase sales, and improve return on marketing investment.</p>
