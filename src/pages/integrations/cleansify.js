...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cleansify.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Cleansify Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(14, 14, 14, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Cleansify, an email validation service, helps you eliminate bounces and avoid spam traps by validating and verifying your emails.</p>
