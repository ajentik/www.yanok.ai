...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/weekday.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Weekday Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(51, 105, 231, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Weekday is a messaging & collaboration platform that brings your team together. For information on how to connect your Weekday channel, please see https://weekdayapp.com/zapier.</p>
  ...
  <div>Creates a new channel message.</div>
</div>
