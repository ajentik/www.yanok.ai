...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/insightly.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Insightly is a CRM and project management app that helps small to medium businesses manage contacts, track relationships, monitor sales pipeline, organize projects and more. It keeps all your critical business info on all your devices, so your company sells more and satisfies customers better.</p>
  ...
  <div>Triggers when a record is deleted.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a field of your choosing (i.e. email address, status) is updated on any record of a specified Insightly object (ie. Contact, Lead, Opportunity, etc.).</div>
</div>
