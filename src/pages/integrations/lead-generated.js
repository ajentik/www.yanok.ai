...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/lead-generated.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Lead Generated Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(20, 182, 183, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Lead Generated is an app to submit and manage leads at https://app.leadgenerated.com</p>
