...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/invanto.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Invanto Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Invanto business centralization suite is designed to provide an all-in-one solution to build & automate your business.</p>
