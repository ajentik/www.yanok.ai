...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/hexomatic.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Hexomatic Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(168, 1, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Hexomatic is a no-code, work automation platform that enables you to harness the internet as your own data source, leverage the most sophisticated AI services and a crowdsourced team of human assistants to automate and delegate time consuming tasks.</p>
