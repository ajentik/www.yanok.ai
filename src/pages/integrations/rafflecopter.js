...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rafflecopter.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Rafflecopter allows you to customize and embed an entry form on your site that incentivizes your audience to perform tasks in exchange for entries into a sweepstakes.</p>
