...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zoho-books.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Zoho Books Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 191, 165, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Zoho Books is cloud-based accounting software in which you can record, audit and analyze all financial transactions easily. With secure data storage, easy navigation and customizable features, Zoho Books provide a head start in accounting for small businesses.</p>
