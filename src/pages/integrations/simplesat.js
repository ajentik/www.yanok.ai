...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/simplesat.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Simplesat Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(78, 198, 119, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Simplesat is a survey tool that makes it easy for any business to collect, analyze and publish customer feedback.</p>
