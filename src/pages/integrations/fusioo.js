...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/fusioo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Fusioo helps growing businesses get organized. Create your custom online database and manage everything in one place.</p>
  ...
  <div>Creates a new record for an App you specify.</div>
</div>
