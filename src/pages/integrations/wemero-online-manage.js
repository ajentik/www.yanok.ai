...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/wemero-online-manage.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Wemero Online Manage Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(15, 15, 15, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Wemero Online Manage is a CRM that manages your your service, customers, products, gift-cards, and memberships whether you’re running a beauty salon or hair salon or massage parlour or tattoo salon or you are working as beauty hair stylist.</p>
