...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/engage-interactive-sms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Engage Interactive - SMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(56, 178, 168, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Engage Hub brings together a range of consumer engagement channels under a single platform. Timely SMS, MMS, Voice, Contextually relevant emails, Facebook Messenger, WeChat and many others.</p>
  ...
  <div>Sends an SMS to a nominated recipient (mobile number).</div>
</div>
