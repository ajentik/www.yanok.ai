...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/helpdeskadvanced.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        HelpdeskAdvanced Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(249, 180, 80, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">HelpdeskAdvanced is an ITIL v3 compliant web- and mobile-based solution governing services across all organisational areas where Service Management is a key factor in the successful achievement of your company’s objectives.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an asset is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new site is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create Asset in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Contact</div>
  <div>Create Contact in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Site</div>
  <div>Create Site in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Task</div>
  <div>Create Task in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Ticket</div>
  <div>Create Ticket in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Asset</div>
  <div>Update Asset in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Contact</div>
  <div>Update Contact in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Site</div>
  <div>Update Site in Helpdesk Advanced</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Task</div>
  <div>Update Task in Helpdesk Advanced</div>
</div>
