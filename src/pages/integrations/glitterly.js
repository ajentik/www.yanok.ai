...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/glitterly.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Glitterly Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(88, 79, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Glitterly is an image generation platform with simple tools and an image generation API to help you automatically create beautiful images for social media, banners, ecommerce, or publishing.</p>
  ...
  <div>Create a image from one of your templates</div>
</div>
