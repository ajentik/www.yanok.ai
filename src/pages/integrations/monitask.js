...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/monitask.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Monitask Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(114, 27, 124, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Monitask allows employees and freelancers to manually start a clock when they begin working on an assignment for employers.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a Time Entry</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create User</div>
  <div>Create a user by email</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add User to Task</div>
  <div>Add User to Task</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Project by Id</div>
  <div>Finds a exists Project By Id.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Project by Name</div>
  <div>Find project by full name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Task by Name</div>
  <div>Find task by full task name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find User by Username</div>
  <div>Find user by full name (first name last name), username or email.</div>
</div>
