...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/ongage.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Powered by a feature-rich dashboard that hosts advanced segmentation tools and a full suite of analytics, ultimately helping marketers drive measurable growth and increase deliverability.</p>
