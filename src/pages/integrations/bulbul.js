...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bulbul.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Bulbul Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(22, 68, 155, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Bulbul is a CRM that helps you organize and track your deals. Everything is stored in a tidy timeline so that you don’t miss anything about a deal.</p>
