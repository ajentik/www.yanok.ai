...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rank-ranger.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Rank Ranger Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Worldclass SEO software powered by big data allowing you to monitor, analyze and improve your SEO ranking and optimize marketing & social media campaigns.</p>
