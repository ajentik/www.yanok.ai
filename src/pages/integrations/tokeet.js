...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tokeet.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Tokeet allows you to easily manage your vacation rentals and manage all your reservations with our all-in-one solution.</p>
