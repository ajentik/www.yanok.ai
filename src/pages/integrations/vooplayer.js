...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vooplayer.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Vooplayer Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">vooPlayer is a professional video hosting solution with a sophisticated suite of video marketing tools that helps businesses grow with video.</p>
