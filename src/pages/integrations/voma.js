...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/voma.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Voma Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 84, 102, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Voma is a payment platform that enables creators to sell online courses, membership sites, digital products, paid email newsletters, or monthly subscriptions.</p>
