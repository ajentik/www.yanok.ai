...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/botatbot.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        BotatBot Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">BotatBot allows anyone to create their own bots on Telegram Messenger, without coding. Automatically send broadcasts to all your bot subscribers.</p>
  ...
  <div>Send a message to your bot</div>
</div>
