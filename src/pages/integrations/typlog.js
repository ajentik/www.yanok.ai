...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/typlog.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Typlog is a blogging and podcasting platform for your stories and voices.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Subscriber Added</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Create Episode</div>
  <div>Creates a new episode.</div>
</div>
