...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/design-shifu.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Design Shifu Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(86, 32, 97, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Design Shifu offers flat rate, subscription-based graphic design services for high-growth start-ups, marketing teams and digital agencies</p>
  ...
  <div>Creates a new design request</div>
</div>
