...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/credit-repair-cloud.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Cloud-based Credit Repair Software and CRM. For mortgage brokers and entrepreneurs. Help your clients or start a credit repair business.</p>
  ...
  <div>Triggered when you convert status from client to any other status or from any other status to client.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggered when you add a new client.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggered when you add a new lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Client</div>
  <div>Triggered when you update a client.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Lead</div>
  <div>Triggered when you update a lead.</div>
</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Change Client</div>
  <div>Updates a client.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Change Lead</div>
  <div>Updates a lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Affiliate</div>
  <div>Adds a new affiliate.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds a new invoice to client.</div>
</div>
