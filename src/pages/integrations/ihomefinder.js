...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/ihomefinder.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        iHomefinder Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(134, 172, 19, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">IHomefinder is a leading national provider of real estate search technology and websites. Using the Internet Data eXchange (IDX) standard, iHomefinder powers thousands of real estate websites. We partner with a wide array of web designers to integrate our technology into real estate websites.</p>
  ...
  <div>Triggers when a new lead is created from a contact form submission.</div>
</div>
