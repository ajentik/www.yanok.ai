...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/canvas-lms.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Canvas is the trusted, open-source learning management system (LMS) that\'s revolutionizing the way we educate.</p>
