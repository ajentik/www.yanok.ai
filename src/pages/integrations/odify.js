...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/odify.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Odify Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(250, 140, 15, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Odify is a platform for the creation, management and distribution of introductory and onboarding videos, as well as the development of your software.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Sell</div>
  <div>Triggers when a new sell is done.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Use this action to automate user creation.</div>
</div>
