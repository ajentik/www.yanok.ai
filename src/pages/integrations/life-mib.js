...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/life-mib.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Life Mib Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(8, 22, 52, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Life Mib connects agents and customers to a single platform that is reducing the insurance buying process from hours to minutes.</p>
  ...
  <div>Triggers when new appointment is created.</div>
</div>
