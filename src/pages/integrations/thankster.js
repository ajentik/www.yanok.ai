...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/thankster.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Thankster Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(148, 27, 27, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Creates and mails cards and notes with authentic handwriting, requiring only address information and message text. Great for CRM, marketing automation, lead gen, and more.</p>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Send Cards</div>
  <div>Automatically send handwritten cards.</div>
</div>
