...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/servicenow.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ServiceNow Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(41, 62, 64, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ServiceNow specializes in IT services management (ITSM), IT operations management (ITOM) and IT business management (ITBM).</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates an existing record in a table.</div>
</div>
