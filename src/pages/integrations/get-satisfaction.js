...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/get-satisfaction.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Get Satisfaction Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Get Satisfaction is a simple way add support forums to your site. Get Satisfaction lets you create a forum for users to give feedback, make suggestions on new features, and lets you update users on development.</p>
