...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/omega-estimating.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Omega Estimating Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(232, 199, 14, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Relay Construction Solutions is a bid leveling software, connecting project owners, general contractors, and sub-contractors in one tool to deliver and award accurate, on-time bids with far less work.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Project Creation</div>
