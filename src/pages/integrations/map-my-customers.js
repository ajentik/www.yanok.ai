...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/map-my-customers.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Map My Customers Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(48, 99, 228, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Map My Customers is the mobile sales CRM simplifying your team\'s day-to-day.</p>
  ...
  <div>Triggers when a new Company is added to your organization.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Person</div>
  <div>Triggers when a new Person is added to your organization.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Activity</div>
  <div>Triggers when a new Activity is added to your organization.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Deal</div>
  <div>Triggers when a new Deal is added to your organization.</div>
</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Add Record to Group</div>
  <div>Add a Company, Person, or Deal to a group.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add File</div>
  <div>Add file to a Company, Person, or Deal</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Note</div>
  <div>Create Note on a Company, Person, or Deal</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Company</div>
  <div>Creates or Updates a Company.</div>
</div>
