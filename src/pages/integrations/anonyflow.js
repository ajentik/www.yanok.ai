...
export default function Page() {
  return (
    <IntegrationLayout 
      title="AnonyFlow"
      description="AnonyFlow is a simple and powerful service for encryption-based data anonymization / deanonymization and community sharing, Enabling GDPR, CCPA, and HIPAA data privacy protection compliance."
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content="AnonyFlow is a simple and powerful service for encryption-based data anonymization / deanonymization and community sharing, Enabling GDPR, CCPA, and HIPAA data privacy protection compliance." />
        </>
      ),
    },
  };
