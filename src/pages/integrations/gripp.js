...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/gripp.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Gripp Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 111, 187, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Gripp is a team collaboration tool that lets you organize anything and everything to keep your projects on task.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Offer Declined</div>
  <div>Triggers when an offer gets declined.</div>
</div>
