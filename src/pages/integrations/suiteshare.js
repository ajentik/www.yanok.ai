...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/suiteshare.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Suiteshare Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(50, 219, 130, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Suiteshare is a digital marketing platform for lead capture, sales conversion, and analysis of results through WhatsApp.</p>
