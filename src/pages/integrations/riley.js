...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/riley.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Send personalized texts and schedule text campaigns to engage your leads</p>
