...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/mysql.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        MySQL Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(232, 121, 18, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">MySQL is a premier database used in millions of production environments around the world. Easily plug your MySQL database into any web service.</p>
