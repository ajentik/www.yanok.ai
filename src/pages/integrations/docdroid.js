...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/docdroid.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        DocDroid Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 102, 102, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">DocDroid is a document sharing platform. Distribute your PDFs, DOCs and presentations easily using a public URL.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Deleted Document</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Document</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing document.</div>
</div>
