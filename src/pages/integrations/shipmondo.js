...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/shipmondo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Shipmondo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(41, 37, 96, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Shipmondo is a freight booking platform that makes it possible for businesses to book freight and manage shipments across carriers. The integration will import order data from your webshop to your Shipmondo account</p>
  ...
  <div class="font-semibold">Create Draft Shipment</div>
  <div>The draft shipment contains basic information from which a shipment can be created through Shipmondo later.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Item</div>
  <div>This will create a product in Shipmondo</div>
</div>
