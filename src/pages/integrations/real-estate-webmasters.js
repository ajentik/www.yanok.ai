...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/real-estate-webmasters.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Real Estate Webmasters Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(54, 51, 51, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Real Estate Webmasters is a real estate Software-as-a-Service CRM.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a note for a specified lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Lead</div>
  <div>Create a new Lead or update one if it already exists.</div>
</div>
