...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/etapestry.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">eTapestry is the leading web-based, or on-demand, database software for fundraising, donor management, church management, and communication with over 5000 customers worldwide.</p>
