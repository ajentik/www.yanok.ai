...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/coreo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Coreo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 95, 208, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Coreo is a platform that enables you to build your own data collection apps, without getting bamboozled by technical… stuff.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Project User</div>
  <div>Triggers when a user joins a project.</div>
</div>
