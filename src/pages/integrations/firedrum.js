...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/firedrum.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        FireDrum Email Marketing Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(230, 74, 25, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">FireDrum is a robust, affordable email marketing platform. From simple newsletters to enterprise white-label solutions, we’ve got you covered.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new saved search is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new custom field.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Saved Search</div>
  <div>Creates a new saved search.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Campaign</div>
  <div>Finds a campaign by searching.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a custom field by searching.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find List</div>
  <div>Finds a list by searching.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Saved Search</div>
  <div>Finds a saved search by searching.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Saved Search</div>
  <div>Finds a saved search by searching.</div>
</div>
