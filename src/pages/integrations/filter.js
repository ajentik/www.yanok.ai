...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/filter.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Filter by Zapier Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 74, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Only allow a Zap to proceed when a certain condition is met. For example, if you\'re sending a text message when you receive a new email, you could use a Filter that only sends a text message when the email received is from a certain address.</p>
  ...
  <div class="font-semibold">Only continue if...</div>
  <div>Set up rules to specify when this Zap can continue running.</div>
</div>
