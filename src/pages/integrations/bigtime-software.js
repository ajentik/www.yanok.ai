...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/bigtime-software.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        BigTime Software Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">BigTime Software develops integrated time and billing tools that help growing professional services firms track and manage their time.</p>
