...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/passage-ticketing.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Passage Ticketing Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(254, 139, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Passage is an online event ticketing platform that helps event organizers sell tickets, merchandise, and concessions both online and at-the-door.</p>
