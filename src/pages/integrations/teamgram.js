...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/teamgram.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TeamGram Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(2, 99, 167, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TeamGram is a CRM and collaboration tool that helps businesses close more sales and get more done.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Get Lead Sequences</div>
  <div>Used for getting sequences for your leads.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Trigger when a new lead is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Opportunity Closed</div>
  <div>Triggerds when an opportunity is closed.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Custom Document</div>
  <div>Creates a new document in a custom application.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing customer which can be a contact or a company.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Lead</div>
  <div>Finds existing (non converted) leads.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Product</div>
  <div>Finds an existing product in your database.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Find or Create Product</div>
</div>
