...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/revolut-for-business.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Revolut Business Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(45, 118, 227, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Revolut Business is a business account platform with free international payments, prepaid business cards, open API, and apps marketplace.</p>
  ...
  <div>Triggers when you exchange, send or receive money.</div>
</div>
