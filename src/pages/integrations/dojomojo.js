...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/dojomojo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        DojoMojo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">DojoMojo is an online platform that helps its users grow their email list, increase social engagement, and generate sales by running sweepstakes along with performance analytics.</p>
