...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/jusnote.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Jusnote Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 74, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Jusnote is a practice management platform that helps lawyers work more efficiently by making it easy to do tasks like tracking time, managing matters, and generating invoices and reports.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Update Bill Status</div>
  <div>Triggers when a Update bill status.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Matter Status</div>
  <div>Triggers when there\'s a update Matter Status.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Task Status</div>
  <div>Triggers when a update task status.</div>
</div>
