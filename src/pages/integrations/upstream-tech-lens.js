...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/upstream-tech-lens.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Upstream Tech Lens Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 76, 92, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Lens gives everyone in your organization eyes on the ground with aggregated satellite, aerial and environmental data and a powerful workflow for collaborative monitoring.</p>
