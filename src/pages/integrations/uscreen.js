...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Uscreen"
      description={`Uscreen is a fully hosted video platform enabling you to sell and distribute your videos online.`}
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Uscreen</title>
          <meta name="description" content={`Uscreen is a fully hosted video platform enabling you to sell and distribute your videos online.`} />
        </>
      ),
    },
  };
