...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/judgeme.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Judge.me Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(51, 153, 153, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Judge.me helps you collect and display product reviews, site reviews and Q&A in your e-commerce store (Shopify, WooCommerce and BigCommerce).</p>
