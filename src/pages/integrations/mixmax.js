...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/mixmax.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Mixmax’s mission is to do the impossible with email including scheduling meetings, completing surveys, making purchases, and more.</p>
