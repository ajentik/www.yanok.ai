...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sendlane.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Sendlane Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(228, 76, 111, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Sendlane is an email automation platform that allows you to connect and communicate with your subscribers and customers.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Contact Saved</div>
  <div>Triggers when a contact is saved.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a new Subscriber.</div>
</div>
