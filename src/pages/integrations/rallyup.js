...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rallyup.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        RallyUp Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(39, 39, 86, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">RallyUp.com provides nonprofit organizations with their own branded platform for launching amazing virtual fundraising experiences.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a live stream is ended on any of an organization’s campaigns.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Live Stream Started</div>
  <div>Triggers when a live stream is started on any of an organization’s campaigns.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Donor Question Submitted via Contact Organizer</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Sweepstakes Entry Purchased</div>
  <div>Triggers when a Transaction is made that contains Sweepstakes Entries.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Sweepstakes Winners Determined</div>
  <div>Triggers when the winner drawing process is completed on any sweepstakes under this organization’s account.</div>
</div>
