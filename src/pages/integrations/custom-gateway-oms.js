...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/custom-gateway-oms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Custom Gateway OMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(5, 115, 134, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Custom Gateway is a system for creating artwork and managing / distributing orders for personalized and print on demand products.</p>
