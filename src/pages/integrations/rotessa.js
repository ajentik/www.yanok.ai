...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Rotessa"
      description="Rotessa is a payment processing tool that lets you collect ACH and EFT payments in the United States and Canada"
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Rotessa</title>
          <meta name="description" content="Rotessa is a payment processing tool that lets you collect ACH and EFT payments in the United States and Canada" />
        </>
      ),
    },
  };
