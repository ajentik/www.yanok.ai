...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/surveylab.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SurveyLab Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(2, 136, 209, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SurveyLab is a customer feedback software that will help you to build surveys, questionnaires, forms or tests. SurveyLab allows you to collect, analyze data and react in real-time.</p>
  ...
  <div>Triggers when a new survey response is collected.</div>
</div>
  ...
  <div>Add contact to the collector and send survey invitations.</div>
</div>
