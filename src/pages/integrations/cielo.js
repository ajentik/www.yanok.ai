...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cielo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Cielo SA is the leader in electronic payment solutions in Latin America.</p>
