...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/docketwise.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Docketwise Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(96, 211, 194, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Docketwise is a practice management and forms software for immigration lawyers and law firms.</p>
