...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/solargraf.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Solargraf Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(36, 132, 198, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Solargraf is the #1 tool for solar panel installers. Enter any address, draw and send a professional estimate under 1 minute. Easy to use on all devices.</p>
  ...
  <div>Creates a Lead in SolarGraf</div>
</div>
