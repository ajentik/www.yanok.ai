...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/logione-document.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        LogiONE Document Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(10, 134, 250, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">LogiONE Document is a secure cloud base solution to store and share files</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Addresss</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates and uploads a new document</div>
</div>
