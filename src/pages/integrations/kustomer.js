...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kustomer.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Kustomer Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 83, 83, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Kustomer is a powerful omnichannel customer service solution.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a conversation is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Message Updated</div>
  <div>Triggers when a message is updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a new customer in Kustomer</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Update a Conversation</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Customer</div>
  <div>Update an existing customer in Kustomer</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Conversation</div>
  <div>Finds a Conversation</div>
</div>
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Kustomer is a powerful omnichannel customer service solution.`} />
        </>
      ),
    },
  };
