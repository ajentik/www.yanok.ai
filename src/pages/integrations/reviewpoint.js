...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/reviewpoint.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ReviewPoint Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(247, 52, 46, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ReviewPoint is a review management tool that helps with review generation via automated SMS or emails, and review monitoring in one place.</p>
