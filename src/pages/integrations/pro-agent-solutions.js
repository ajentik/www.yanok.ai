...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/pro-agent-solutions.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ProAgentSolutions Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(52, 152, 219, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Pro Agent Solutions helps real estate agents and brokers manage their customer relationships, stay organized and generate leads so they can sell more homes.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a contact using an email address.</div>
</div>
