...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/birdie-screen-recording.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Birdie Screen Recording Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(24, 24, 31, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">With Birdie Screen Recording, users can record their screen and voice and instantly share their feedback in less time than it would take to take screenshots, annotate them and type an email.</p>
  ...
  <div>Triggers when a new feedback has been posted to your Zest account.</div>
</div>
