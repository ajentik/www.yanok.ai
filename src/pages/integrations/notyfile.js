...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/notyfile.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Notyfile Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(10, 150, 155, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Notyfile is a sales driven CRM platform that helps your organisation work better and faster together.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Activated Customer</div>
  <div>Triggers when a customer is activated.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Lost Prospect</div>
  <div>Triggers when a prospect is lost.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new support prospect is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Customer</div>
  <div>Triggers when an customer is updated.</div>
</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Create Agreement</div>
  <div>Creates Agreement / Prospect</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Case</div>
  <div>Creates a case!</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates / Activates a customer</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Post to Feed</div>
  <div>Post something to feed</div>
</div>
