...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/microsoft-todo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Microsoft To Do is an intelligent task management app that makes it easy to plan and manage your day. With its intelligent Suggestions, To Do removes all the clutter and empowers you to focus on what\'s important, when it\'s important.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Marks a task as complete.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a task by title, or creates one if none is found.</div>
</div>
