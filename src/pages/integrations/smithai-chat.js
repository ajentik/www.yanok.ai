...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smithai-chat.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Smith.ai Chat Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 74, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Smith.ai Chat is a live chat + AI chatbot service. Capture more quality leads for your businesses via web chat, text message, and Facebook.</p>
