...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/planso.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        PlanSo Forms for WordPress Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(26, 139, 73, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">PlanSo Forms is a form management and creation tool. It can be used directly or via wordpress plugin.</p>
