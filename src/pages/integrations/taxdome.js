...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/taxdome.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TaxDome Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(24, 118, 211, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TaxDome is an all-in-one solution for tax and accounting professionals to manage their business.</p>
