...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/appsheet.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        AppSheet Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 96, 217, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">AppSheet is a no-code app development platform that lets you build desktop & mobile apps for your business from spreadsheet data.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Deletes an existing record.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Invoke Action</div>
  <div>Invokes a user defined Action that updates an existing record.</div>
</div>
