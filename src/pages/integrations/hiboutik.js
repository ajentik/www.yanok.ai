...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/hiboutik.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Hiboutik Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Free POS software for all retail shops. Easy to set up, you just need a web browser to create your own POS system.</p>
