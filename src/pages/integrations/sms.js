...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SMS by Zapier Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(73, 157, 243, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Using our built-in number, you can send a limited number of SMS / text messages. This is great for reminders!</p>
  ...
  <div>Send an SMS to a number. Notice that a successful action means that the SMS has been queued, not delivered.</div>
</div>
