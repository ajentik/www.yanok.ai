...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/snapaddy.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        snapADDY Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">snapADDY is a sales support software for finding B2B contacts and directly transferring them to CRM and ERP systems.</p>
