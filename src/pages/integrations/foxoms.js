...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/foxoms.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">FoxOMS is resource scheduling software for creative agencies.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a person and define them as a user, resource and client.</div>
</div>
