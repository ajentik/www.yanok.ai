...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/timecamp.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TimeCamp Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(89, 190, 123, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TimeCamp helps you and your team to track time. Automatic time-tracking software that tracks websites and applications usage, projects and helps you understand how your time is spent.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Task or Project</div>
  <div>Triggers when a new task or project is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates keywords in an existing task.</div>
</div>
