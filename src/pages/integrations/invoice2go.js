...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/invoice2go.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Invoice2go Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(50, 75, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Invoice2go is the all-in-one tool that helps you run your small business. Manage customer relationships, send invoices, accept payments, improve cash flow, create an online presence, and much more.</p>
  ...
  <div>Create a client in Invoice2go</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Item</div>
  <div>Create an item in Invoice2go</div>
</div>
