...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/radius.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Radius is built specifically for Insurance Agents and Agencies, but every agency does their day to day differently which is why Radius allows for unique customization for each account.</p>
