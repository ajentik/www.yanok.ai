...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tangelo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Tangelo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(80, 206, 162, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Tangelo is making employee onboarding approachable and easy. With our simple checklists, employees know exactly what to focus on to get ramped up faster than ever.</p>
