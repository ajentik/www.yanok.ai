...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/manictime.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ManicTime Cloud Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(24, 99, 146, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ManicTime allows you to keep up with your employees’ work, send accurate progress reports, and manage your time better than ever before.</p>
