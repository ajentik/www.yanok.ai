...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/leadowl.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        LeadOwl Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(68, 138, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">LeadOwl is a smart phone & web app that allows you and your team to connect funnels, get reminders, and follow up with prospects instantly.</p>
