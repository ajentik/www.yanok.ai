...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Podia"
      description={`Podia lets anyone sell memberships, online courses and digital downloads online.`}
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Podia</title>
          <meta name="description" content={`Podia lets anyone sell memberships, online courses and digital downloads online.`} />
        </>
      ),
    },
  };
