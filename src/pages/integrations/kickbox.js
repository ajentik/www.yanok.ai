...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kickbox.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Kickbox Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(202, 219, 42, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Kickbox is an email verification platform that can help identify deliverable, invalid, or otherwise risky email addresses. Using Kickbox you can ensure you only ever send emails to real addresses - reduce bounce rates and improve inbox placement.</p>
  ...
  <div>Verifies the provided email address to identify whether the address is deliverable, undeliverable, or risky.</div>
</div>
