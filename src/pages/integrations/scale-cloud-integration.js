...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Scale Cloud"
      description={`ScaleCloud is KPI Management Tool to achieve business scale-up.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`ScaleCloud is KPI Management Tool to achieve business scale-up.`} />
        </>
      ),
    },
  };
