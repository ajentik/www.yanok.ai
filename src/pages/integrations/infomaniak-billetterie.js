...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/infomaniak-billetterie.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Infomaniak Billetterie Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(235, 73, 105, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Infomaniak Billetterie is a ticketing solution for discerning organisers. From selling to checking tickets, calmly master all the aspects involved in organising your events.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Scan Ticket</div>
  <div>Triggers when a ticket is scanned.</div>
</div>
