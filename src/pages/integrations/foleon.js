...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/foleon.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Foleon is a content creation platform that empowers business teams to create engaging and intelligent content experiences at scale.</p>
