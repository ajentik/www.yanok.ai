...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/openpath.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Openpath provides mobile enabled cloud-based access control system solutions that support mobile phone, badge, and key card credentials, and PIN codes.</p>
