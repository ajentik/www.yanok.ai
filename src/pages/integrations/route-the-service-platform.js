...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/route-the-service-platform.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Route the Service Platform Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(10, 10, 10, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Walkthrough, bidding and proposal software for commercial cleaning companies.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a location by name or address.</div>
</div>
