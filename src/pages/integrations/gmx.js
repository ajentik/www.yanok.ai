...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/gmx.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Advanced, Savvy, Different. With 13 million customers strong, GMX is the ideal email solution for you.</p>
