...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kanbanflow.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        KanbanFlow Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(244, 121, 32, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">KanbanFlow is a Lean project management tool for you and your team. Its intuitive user interface will get you up and running in a few minutes. It has a built-in task timer with support for the Pomodoro technique.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a task is moved between columns or swimlanes.</div>
</div>
  ...
  <div>Creates a new task in a specific column/swimlane on the board.</div>
</div>
