...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/project-bubble.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Project Bubble Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(128, 195, 65, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The simple and easy way to manage your projects. Spend less time learning a project management system, and more time being productive. Manage your projects online, track time, set deadlines, stay on budget, share files, be productive!</p>
