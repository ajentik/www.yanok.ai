...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sakari-sms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Sakari SMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(46, 126, 237, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Sakari is a platform for sending and receiving SMS messages. Our platform is optimized for sending customized messages in bulk allowing recipients to feel more engaged with your business.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a contact by mobile number.</div>
</div>
