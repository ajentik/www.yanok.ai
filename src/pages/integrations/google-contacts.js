...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/google-contacts.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Google Contacts, the address book built into Gmail, lets you keep track of all your contacts, see when you last interacted with them, and more.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Upload Contact Photo</div>
  <div>Uploads a profile photo to an existing contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contact</div>
  <div>Finds a contact by name or email.</div>
</div>
