...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/reviewstudio.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ReviewStudio Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(57, 181, 74, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ReviewStudio is online proofing software for marketing teams, ad agencies, creatives and production studios.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Approval Decision</div>
  <div>Triggers when a new approval decision is made for a given review file.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New File Approval</div>
  <div>Triggers whenever a file is approved</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Pending Task</div>
  <div>Triggered when a new (pending) task is created</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new review is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Review</div>
  <div>Create a Review</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Client</div>
  <div>Searches for a Client</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Clients</div>
  <div>Searches for a Client</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Projects</div>
  <div>Finds a Project</div>
</div>
