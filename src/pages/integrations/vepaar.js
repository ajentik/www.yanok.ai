...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vepaar.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Vepaar app contains all the tools you need to create your business page, efficiently communicate with your business contacts, manage your sales pipeline, build an e-commerce store, and run polls.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Campaign List</div>
  <div>Triggers when getting the campaign list.</div>
</div>
