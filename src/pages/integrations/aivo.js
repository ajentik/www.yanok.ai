...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/aivo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Aivo is a company that develops artificial intelligence solutions with the aim of transforming the way companies and customers interact.</p>
