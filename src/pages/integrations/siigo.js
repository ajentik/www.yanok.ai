...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/siigo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Siigo Nube is an Accounting and Administrative software for SMBs companies.</p>
