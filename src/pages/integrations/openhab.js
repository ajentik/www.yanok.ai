...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/openhab.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">openHAB - a vendor and technology agnostic open source automation software for your home</p>
