...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/corymbus.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Corymbus Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(51, 105, 30, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Corymbus is a CRM platform devoted to small businesses and freelances. It focuses on an extremely straightforward user experience. It covers the needs of both sales and marketing.</p>
