...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/simplybook.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SimplyBook.me Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(17, 198, 243, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SimplyBook.me is online appointment and scheduling software, that allows to accept bookings 24/7 and offers variety of flexible features.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when the following booking details are updated: date, time, service, or provider.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new client created.</div>
</div>
