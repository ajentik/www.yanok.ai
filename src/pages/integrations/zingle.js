...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zingle.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Zingle provides real-time business text messaging solutions in both SMS and MMS to increase customer engagement and loyalty.</p>
