...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/recurly.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Recurly Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(126, 60, 151, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Recurly is a subscription management platform delivering a competitive advantage for leading brands worldwide. Trusted by Sling TV, BarkBox, Asana, and thousands more to drive recurring revenue.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggered when a new Invoice is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Push Notification</div>
  <div>Get instant triggers for Accounts, Subscriptions, and Payments.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Subscription</div>
  <div>Triggered when a new Subscription is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Transaction</div>
  <div>Triggered when a transaction is added.</div>
</div>
  ...
  <div>Create a new account automatically.</div>
</div>
