...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/onepgr.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        OnePgr Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(26, 81, 138, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">OnePgr offers a communication & collaboration platform to help automate your organizational workflow for business processes such as Sales, Support, IT, HR, allowing you to hold online meetings, make phone calls, share documents, and send text messages seamlessly from your tools.</p>
