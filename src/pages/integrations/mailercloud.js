...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/mailercloud.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Mailercloud Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(4, 109, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Mailercloud is a cloud-based email marketing platform that allows businesses to launch email marketing campaigns without having any technical expertise.</p>
  ...
  <div>Adds a new contact to the selected Mailercloud list\'s.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Contact</div>
  <div>Update a existing contact in your account.</div>
</div>
