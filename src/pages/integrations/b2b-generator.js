...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/b2b-generator.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        B2B Generator Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(1, 117, 175, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">B2B Generator instantly repurposes product data into multiple digital sales and marketing channels while maximizing reseller interconnection</p>
