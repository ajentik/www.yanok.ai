...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/the-giving-block.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        The Giving Block Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(40, 27, 79, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The Giving Block is a crypto donation solution, allowing nonprofits to fundraise Bitcoin, Ethereum and many other cryptocurrencies.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new organization is created or an existing one updated.</div>
</div>
