...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/amazon-seller-central.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Amazon Seller Central Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(248, 152, 29, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Amazon Seller Central enables both individuals and businesses to sell their products and inventory on Amazon.com (US accounts only).</p>
