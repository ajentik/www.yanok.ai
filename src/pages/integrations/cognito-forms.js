...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cognito-forms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Cognito Forms Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(216, 84, 39, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Cognito Forms is an easy-to-use form builder that allows users to quickly build a form, include it on their website, and start capturing entries without having to do any development.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a payment is collected.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Refund</div>
  <div>Triggers when a refund is issued.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Entry</div>
  <div>Triggers when someone updates an entry.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Set Form Availability</div>
  <div>Sets the availability of a form.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Get Document</div>
  <div>Gets an entry document.</div>
</div>
