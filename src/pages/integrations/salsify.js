...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/salsify.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Salsify\'s Product Experience Management (PXM) platform enables brands to deliver the product experiences consumers demand.</p>
