...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kea.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        KEA Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 175, 170, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Kea is a digital legal workspace that helps individual lawyers and entire legal teams to create and deliver better legal services, together.</p>
  ...
  <div>Uploads a file to Matter, Task or Ticket</div>
</div>
