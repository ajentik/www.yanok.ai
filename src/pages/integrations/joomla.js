...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/joomla.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Joomla! is a popular open source CMS that is powerful and easy to use. Combined with extensions like RSform and Proforms, its a powerful tool for creating a web presence.</p>
