...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/funneldash.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        FunnelDash Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Funneldash is the ultimate agency growth funnel software as it combines data from multiple CRM, Payment and Advertising solutions to show key metrics about your funnels.</p>
