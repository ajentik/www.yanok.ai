...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rindle.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Rindle is a task and project management automation application for business that easily tracks projects and tasks in software your team will want to use.</p>
