...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/raklet.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Raklet Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(44, 110, 212, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Raklet is a CRM to help manage contacts, messages and payments. Schedule email and SMS, collect payments online and more.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds a note to the specified contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add Tag to Contact</div>
  <div>Adds a Tag to the Specified Contact.</div>
</div>
