...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cloud-attract.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Cloud Attract Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(253, 81, 84, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Cloud Attract is a lead capture tool to attract buyers and sellers with beautiful landing pages that automatically respond with a home valuation, CMA, or listing alerts.</p>
