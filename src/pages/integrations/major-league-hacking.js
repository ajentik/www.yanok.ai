...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/major-league-hacking.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Major League Hacking Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Major League Hacking (MLH) is the official student hackathon league. Each year MLH supports over 65.000 students around the world.</p>
