...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Taskworld"
      description={`Receive your Taskworld notifications in any app and collaborate more effectively!`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Receive your Taskworld notifications in any app and collaborate more effectively!`} />
        </>
      ),
    },
  };
