...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/autochartist.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Autochartist Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Autochartist is a powerful pattern recognition tool that simplifies Technical Analysis for traders by identifying 100’s of trading opportunities based on key support and resistance levels.</p>
