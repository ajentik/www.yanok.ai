...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/onebill.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        OneBill Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(240, 81, 35, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">OneBill is a billing and subscription management platform for businesses offering a range of products/services based around subscription.</p>
  ...
  <div>Triggers when an invoice is generated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a payment is recorded.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a payment entry against a subscriber.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Lead</div>
  <div>Finds a lead (including their account number).</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Subscriber</div>
  <div>Finds a subscriber (including their account number).</div>
</div>
