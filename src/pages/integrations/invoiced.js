...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/invoiced.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Invoiced Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(29, 100, 240, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Invoiced is autopilot for accounts receivable.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Invoice Paid in Full</div>
  <div>Triggers when an invoice is paid in full.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Credit Balance Adjustment</div>
  <div>Creates a new credit balance adjustment.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Credit Note</div>
  <div>Creates a new credit note.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Pending Line Item</div>
  <div>Creates a new pending line item.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find Credit Note</div>
  <div>Finds a credit note by ID or credit note number.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Estimate</div>
  <div>Finds an estimate by ID or estimate number.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Invoice</div>
  <div>Finds an invoice by ID or invoice number.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Customer</div>
  <div>Finds an existing customer, or creates one if it does not exist.</div>
</div>
