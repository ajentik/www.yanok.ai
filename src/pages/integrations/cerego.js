...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cerego.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Cerego is an adaptive learning platform that uses artificial intelligence and machine learning to scale proven cognitive science and make learning possible for anyone.</p>
