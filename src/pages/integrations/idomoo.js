...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/idomoo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Idomoo’s Personalized Marketing Videos enable you to easily engage with your customers on a truly personal level, driving loyalty and revenue growth.</p>
