...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/review-generation-inc.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Review Generation Inc. Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Review Generation Inc. is a CRM that allows you to send review requests to your customers via SMS and Email to keep your company\'s online reputation healthy.</p>
  ...
  <div>Adds Contact to specified campaign</div>
</div>
