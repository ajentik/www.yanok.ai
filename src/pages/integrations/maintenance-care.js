...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/maintenance-care.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Maintenance Care Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 149, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Maintenance Care is a CMMS software for work orders, preventive maintenance and asset management.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Delayed Task</div>
  <div>Triggers when a task is delayed.</div>
</div>
