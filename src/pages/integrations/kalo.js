...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/kalo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Kalo\'s Freelance Management System enables the world\'s biggest companies to organize, onboard, manage, and pay their freelance workforce.</p>
