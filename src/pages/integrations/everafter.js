...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/everafter.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        EverAfter Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(121, 60, 251, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">B2B Customer Hub Platform for Customer Onboarding & Retention.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create or Update Account</div>
  <div>Creates or updates an account</div>
</div>
