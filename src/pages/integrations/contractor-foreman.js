...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/contractor-foreman.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Contractor Foreman is the most affordable all-in-one construction management software for contractors and is trusted by contractors in more than 75 countries. Recently named a Top App by DailyReporter.com, Capterra, SoftwareAdvice and ConstrucTECH.</p>
  ...
  <div>Triggers when customer is deleted.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Customer Archived</div>
  <div>Triggers when customer is Archived.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">File Uploaded</div>
  <div>Triggers when upload File is uploaded.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Lead Deleted</div>
  <div>Triggers when lead is deleted.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Lead Archived</div>
  <div>Triggers when lead is Archived.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Customer Created to CF</div>
  <div>Triggers when a new Customer is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Lead Created to CF</div>
