...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/socie.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Socie Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(65, 155, 249, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Socie is the top down communication app for societies, companies and associations. We serve a large variety of communities, such as sports clubs, churches, businesses and many others.</p>
  ...
  <div class="font-semibold">Create a Membership</div>
