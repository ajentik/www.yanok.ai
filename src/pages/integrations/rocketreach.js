...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rocketreach.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        RocketReach Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(63, 89, 150, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">RocketReach helps you find email, phone and social links for over 250 million professionals, across 6 million companies, worldwide.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for people by keyword, name, title, company.</div>
</div>
