...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/seize-the-market.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Seize the Market Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Seize the Market is a All in One, Lead to Close Business Solution for Real Estate Agent, Team, Brokers.</p>
  ...
  <div>Process a New Lead Submission.</div>
</div>
