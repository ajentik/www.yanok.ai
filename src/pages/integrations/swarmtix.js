...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/swarmtix.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Swarmtix Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 255, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The simplest event ticketing platform. Create, promote and sell your events in 10 minutes.</p>
