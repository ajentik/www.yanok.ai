...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/anapro.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">From the customer service to the signing of the contract., Anapro offers complete commercial management for small, medium and large businesses.</p>
