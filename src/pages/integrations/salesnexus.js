...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/salesnexus.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SalesNexus Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(229, 81, 36, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SalesNexus is lead generation, lead management plus sales process automation and full featured CRM, that\'s simple to set up and use.</p>
