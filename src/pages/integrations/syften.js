...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/syften.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Syften is a keyword monitor and notifier. It will alert you whenever one of your keywords is mentioned on Reddit, Stack Exchange, Hacker News or others.</p>
  ...
  <div>Triggers when a new mention is found</div>
</div>
