...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/genesys.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Genesys is an omnichannel customer experience (CX) and contact center solutions in the cloud and on-premises.</p>
