...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Crystal"
      description="Crystal is a team organizations tool. It gives everyone in your team a shared view of roles, docs and purpose with interactive maps."
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Crystal</title>
          <meta name="description" content="Crystal is a team organizations tool. It gives everyone in your team a shared view of roles, docs and purpose with interactive maps." />
        </>
      ),
    },
  };
