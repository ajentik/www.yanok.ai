...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/helium10-portals.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Portals by Helium10 Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 56, 115, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Portals allows you to create your own custom landing pages to capture leads, increase sales, and grow your Amazon business.</p>
  ...
  <div>Create Customer for Portals</div>
</div>
