...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/realsavvy.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Realsavvy Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">All-in-1 real estate platform with custom websites, Pinterest-style IDX, branded mobile apps and a powerful CRM.</p>
