...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/numetric.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        NuMetric Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 111, 184, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">NuMetric is a one stop accounting platform for your business</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new business is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new transaction occurs.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an invoice\'s due date matches with today\'s date.</div>
</div>
  ...
  <div>Creates a new account in charts of account</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Credit Note</div>
  <div>For creating a credit note</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>For creating debit note</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Tax</div>
  <div>For creating a tax</div>
</div>
