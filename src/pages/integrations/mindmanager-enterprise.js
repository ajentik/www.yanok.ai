...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/mindmanager-enterprise.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        MindManager Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(43, 87, 154, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">MindManager is productivity software for visualizing and managing complex information, such as detailed project plans. MindManager mind maps, flow charts, Gantt charts, and other diagrams help users more accurately define and validate project schedules, dependencies, workflows and resources.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Zap Topic</div>
  <div>Triggers when a topic in MindManager is zapped.</div>
</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">New Subtopic</div>
  <div>Add a subtopic to your MindManager desktop application.</div>
</div>
