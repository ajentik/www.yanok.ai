...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/brosix.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Brosix Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(69, 153, 218, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Brosix is a secure instant messenger for your team, offering unlimited file transfer, screen-sharing, audio and video calls, and many more collaboration features to improve your team performance.</p>
  ...
  <div>Send a Message to a Brosix account</div>
</div>
