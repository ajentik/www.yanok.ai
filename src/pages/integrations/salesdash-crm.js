...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Salesdash CRM"
      description={`Salesdash CRM helps small businesses grow sales with our simple client management software.`}
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/salesdash-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Salesdash CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 74, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Salesdash CRM helps small businesses grow sales with our simple client management software.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new contact created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a Deal.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Account</div>
  <div>Update a account</div>
</div>
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Salesdash CRM</title>
          <meta name="description" content={`Salesdash CRM helps small businesses grow sales with our simple client management software.`} />
        </>
      ),
    },
  };
