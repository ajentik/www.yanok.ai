...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sitedocs.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SiteDocs Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SiteDocs is a digital safety management system that allows you to move your entire safety program from paper, clipboards and filing cabinets to the iPad and web.</p>
