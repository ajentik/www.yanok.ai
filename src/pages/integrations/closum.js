...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/closum.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CLOSUM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(45, 101, 221, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Closum is a inbound marketing platform, focused on small and medium companies to do their own landing pages, newsletters and send sms marketing in a simple way.</p>
  ...
  <div>Add a new lead to account</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Send SMS</div>
  <div>Send a Single SMS to a specific Recipient</div>
</div>
