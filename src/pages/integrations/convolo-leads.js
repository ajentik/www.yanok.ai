...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/convolo-leads.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Convolo Leads Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(63, 191, 170, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Convolo Leads is a lead-to-call automation tool that connects a phone call between your sales people and your new leads within 30 seconds after they showed interest.</p>
