...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tokko-broker.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Tokko Broker Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Tokko Broker is a real estate app that lets you sync your listings on real estate portals and your website automatically. You can also receive and follow up on your leads.</p>
  ...
  <div class="font-semibold">Create Web Contact</div>
  <div>Creates a new web contact.</div>
</div>
