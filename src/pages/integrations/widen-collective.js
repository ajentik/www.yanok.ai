...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/widen-collective.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Widen Collective Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(218, 81, 16, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Widen Collective is a digital asset management solution that brings together all of your image, video and creative files in one location to quickly find, access and share – anytime, anywhere, on any device.</p>
  ...
  <div>Uploads an asset from a file or URL.</div>
</div>
