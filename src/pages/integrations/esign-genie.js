...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/esign-genie.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        eSign Genie Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 194, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">eSign Genie is an easy, cost-effective, comprehensive and legally binding end-to-end esignature solution with Templates, Bulk Signing, Online Forms, APIs.</p>
