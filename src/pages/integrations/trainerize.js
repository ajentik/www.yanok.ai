...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Trainerize"
      description={`Trainerize is a powerful personal training software to grow your business and reach more clients with online personal training, meal planning, in-app communication and workout tracking.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Trainerize is a powerful personal training software to grow your business and reach more clients with online personal training, meal planning, in-app communication and workout tracking.`} />
        </>
      ),
    },
  };
