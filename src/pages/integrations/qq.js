...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/qq.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Tencent QQ , also known as QQ, is an instant messaging software service developed by the Chinese company Shenzhen Tencent Computer System Co.,</p>
