...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/teamwave.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TeamWave Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(61, 128, 202, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TeamWave is an unified platform for project management, CRM, and HR software for small businesses.</p>
  ...
  <div>Trigger when a new person is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when new event is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Milestone</div>
  <div>Triggers when Milestone is added.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new task list is added.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Timelog</div>
  <div>Triggers when New Timelog is made.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Deal Matching Filter</div>
  <div>Triggers when a deal is moved to selected Stage.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when deal is upadted.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds a follower to a deal.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>This creates project from available templates.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing deal. Optionally, create one if none are found.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Organization</div>
  <div>Find an organization.</div>
</div>
