...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/instagram.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Instagram is a social network which is a fast, beautiful and fun way to share your photos with friends and family.</p>
  ...
  <div>Triggers when a photo or video is posted to your account.</div>
</div>
