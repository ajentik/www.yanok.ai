...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/fiverr-workspace.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Fiverr Workspace Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(15, 26, 38, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Fiverr Workspace is freelancing software that helps you run your business from proposal to payment.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new income is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Income</div>
  <div>Creates a new income.</div>
</div>
