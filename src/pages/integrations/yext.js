...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/yext.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Yext is a data management tool that is designed to keep track of your business\' location-related information on multiple directories.</p>
