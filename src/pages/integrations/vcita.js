...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vcita.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        vcita Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(12, 49, 94, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">vCita is a client engagement solution for small businesses, including lead generation, online scheduling, document sharing, online payments and contact management. vCita is available on desktop, tablet and mobile, easily integrating with any website and online platform.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Created Invoice</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Create a new invoice in vcita. Can currently create an invoice with just one line item.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Message</div>
  <div>Add a new textual message to an existing client.</div>
</div>
