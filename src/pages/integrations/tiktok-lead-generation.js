...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tiktok-lead-generation.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TikTok Lead Generation Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(254, 65, 102, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TikTok\'s Lead Generation enables businesses of all sizes to create seamless interactions to reach prospects in order to convert them into potential customers.</p>
