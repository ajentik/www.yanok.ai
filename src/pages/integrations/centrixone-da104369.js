...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/centrixone-da104369.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CentrixOne Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(155, 40, 176, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">CentrixOne is a full featured yet easy-to-use CRM, e-mail and marketing automation platform for SMB’s.</p>
