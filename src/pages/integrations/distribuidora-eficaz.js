...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/distribuidora-eficaz.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Distribuidora Eficaz Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(8, 110, 158, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Distribuidora Eficaz is a specialist ERP system for order and inventory management.</p>
