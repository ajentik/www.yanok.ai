...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/revamp-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Revamp CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(15, 36, 67, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Revamp CRM is a Sales & Marketing CRM. Make more sales whether you are using multiple sales pipelines or an eCommerce store.</p>
  ...
  <div>Triggers when matching people with this criteria.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Deal Matching Filter</div>
  <div>Triggers when matching deals with this criteria.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when matching organizations with this criteria.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Task Matching Filter</div>
  <div>Triggers when matching tasks with this criteria.</div>
</div>
