...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/email-hippo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Email Hippo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(132, 189, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Email Hippos is an email intelligence platform to stop bad emails getting into your systems. MORE shields your forms from fraudsters and typos in real-time.</p>
