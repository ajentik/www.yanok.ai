...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/salesquared.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Salesquared Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 72, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Salesquared is a leading email validation service. We provide APIs with complete SDKs and integrations, so you can seamlessly automate your email collection process. Validating email addresses in real-time is easier than ever.</p>
  ...
  <div>Validates the given email address.</div>
</div>
