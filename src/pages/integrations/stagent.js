...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/stagent.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Stagent Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(83, 95, 225, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Software for booking agencies, artists and managers in the music and entertainment industry.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Search Artists</div>
  <div>Searches artists.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Bookings</div>
  <div>Searches bookings.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Companies</div>
  <div>Searches companies.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Contacts</div>
  <div>Searches contacts.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Events</div>
  <div>Searches events.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Search Teams</div>
  <div>Searches teams.</div>
</div>
