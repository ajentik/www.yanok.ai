...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/powr-form-builder.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        POWR Form Builder Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(82, 135, 223, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">POWR Form Builder is an easy way to collect information, grow your email list, and take payments online on all devices and platforms.</p>
  ...
  <div>Trigger when there is new form response.</div>
</div>
