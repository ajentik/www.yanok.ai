...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/paperbell.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Paperbell Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(34, 34, 34, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Paperbell is the easiest way to sell coaching online – whether you’re an experienced coach, or you’re just getting started.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new client is added to your account.</div>
</div>
