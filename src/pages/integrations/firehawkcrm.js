...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/firehawkcrm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        FireHawkCRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(161, 48, 19, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">FireHawkCRM is great for small business. We help you look after your customers, so they’ll tell the world how good you are! Quotes, Invoices, Email and File sharing all in one neat little package.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a Payment against an invoice</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Find invoice by invoice number</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Payment</div>
  <div>Find existing payments</div>
</div>
