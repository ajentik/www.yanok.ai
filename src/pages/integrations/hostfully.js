...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/hostfully.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Hostfully Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(35, 82, 124, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Hostfully is a complete, end-to-end property management platform that helps vacation rental PMs boost revenues.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new booking arrives.</div>
</div>
