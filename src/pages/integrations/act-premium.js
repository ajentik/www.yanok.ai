...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/act-premium.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Collaborate with your team to stay up-to-date on the latest contacts and automate best practice sales processes.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Auth Test</div>
  <div>Tests authentication by getting 1 contact.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Adds an activity to a contact.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Add History</div>
  <div>Adds a history to a contact.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Updates a new contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Contact</div>
  <div>Finds or creates a contact.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Group</div>
  <div>Looks up groups in Act!</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Update or Create Contact</div>
  <div>Find or Update or Create Contact</div>
</div>
