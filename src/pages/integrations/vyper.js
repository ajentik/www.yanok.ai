...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vyper.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">VYPER is a viral marketing software created to help business, organizations, sales and marketing teams to harness the power viral contests.</p>
