...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/dude-solutions.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Dude Solutions Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Dude Solutions is a leading SaaS provider of operations management solutions to education, government, healthcare, manufacturing and membership-based organizations.</p>
