...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/brandmaker.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        BrandMaker Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(237, 128, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">BrandMaker is a modular solution suite which is designed to manage the entire marketing process. It enables the planning, budgeting, execution and measurement of all your marketing efforts.</p>
