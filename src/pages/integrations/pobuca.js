...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/pobuca.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Pobuca Connect Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(34, 193, 197, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Pobuca Connect is an AI digital assistant that optimizes the way your business stores and communicates with business contacts.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a contact is added or updated.</div>
</div>
