...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/brivity.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Brivity Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(89, 196, 196, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Brivity is a cloud-based CRM platform for real estate professionals & brokerages.</p>
