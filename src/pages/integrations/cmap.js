...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cmap.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Cloud platform for creating and embedding Location Analytics into enterprise apps and Business Intelligence.</p>
