...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/insurance-website-builder-ca1153.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Insurance Website Builder Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(215, 38, 41, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ITC’s Insurance Website Builder builds websites for insurance agencies in the United States. Our insurance website experts know insurance website design so you get a strong online presence.</p>
  ...
  <div>Triggers when a form is filled on you insurance website builder website.</div>
</div>
