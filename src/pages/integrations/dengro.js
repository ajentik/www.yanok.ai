...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/dengro.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">DenGro is a CRM and lead management tool built specifically for the dental industry. Track, nurture and convert more high-value leads to treatment with DenGro.</p>
