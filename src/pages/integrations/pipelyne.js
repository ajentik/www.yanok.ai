...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/pipelyne.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Pipelyne Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(41, 40, 69, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Pipelyne allows you to create questionnaires that will provide your leads with instant estimates, allowing you to generate high quality leads for your business.</p>
  ...
  <div>Triggers when a new lead completes a questionnaire</div>
</div>
