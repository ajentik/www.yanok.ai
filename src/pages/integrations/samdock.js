...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/samdock.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Samdock Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(77, 61, 245, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Samdock is a simple CRM system for small businesses.</p>
  ...
  <div>Triggers when the status of a deal gets changed.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Lead / Deal</div>
  <div>Triggers when a new lead or a new deal is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>This action creates a \'Deal\' in Samdock.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Lead</div>
  <div>This action creates a \'Lead\' in Samdock.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Organization</div>
  <div>This action creates an \'Organization\' in Samdock.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Person</div>
  <div>This action creates a \'Person\' in Samdock.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Contact</div>
  <div>Creates a new person, new organization or both linked together.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Request</div>
  <div>This action creates a \'Request\' in Samdock.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Task</div>
  <div>This action creates a \'Task\' in Samdock.</div>
</div>
