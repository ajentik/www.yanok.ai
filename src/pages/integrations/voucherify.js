...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/voucherify.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Build promotional campaigns faster. Programmable building blocks for coupon, referral, and loyalty programs.</p>
