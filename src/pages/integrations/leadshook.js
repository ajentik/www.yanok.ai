...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/leadshook.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        LeadsHook Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(121, 16, 16, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">LeadsHook is an app for creating personalized marketing including lead magnets and sales letters using decision trees.</p>
