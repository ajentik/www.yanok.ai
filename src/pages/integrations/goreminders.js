...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/goreminders.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        GoReminders Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 124, 62, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Text and email appointment reminders for your customers.</p>
