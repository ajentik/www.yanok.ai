...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/pocketsmith.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Manage your budget and forecast your finances with PocketSmith, the best personal finance software on the web. Connect to your bank accounts securely.</p>
