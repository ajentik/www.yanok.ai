...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/slaask.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Slaask is a customer service chat app for Slack that allows you to bring all your teams, clients and communications together in one place.</p>
