...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/jumperai.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Jumper.ai Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(61, 57, 185, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Jumper.ai is a conversational commerce solution that turns digital marketing efforts into direct point of sales.</p>
  ...
  <div>Triggers when a buyer (buying from messenger) cancels the purchase flow.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Customer</div>
  <div>Triggers when New customer starts conversation in Messenger.</div>
</div>
