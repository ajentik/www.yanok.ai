...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/approval.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Approval by Zapier Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Add an Approval Step anywhere to your Zap to enable the manual reviewing or approval a task before it continues to completion. Share your Approval Inbox with any colleague, regardless of if they have a Zapier account or not.</p>
  ...
  <div class="font-semibold">Create Approval</div>
  <div>Creates a new approval.</div>
</div>
