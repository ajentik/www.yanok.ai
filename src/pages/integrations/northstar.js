...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/northstar.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        NorthStar by GrowthHackers Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(18, 172, 142, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">GrowthHackers is a powerful collaboration platform helping marketers and growth professionals unleash their company\'s growth potential. We do this via a community of growth practitioners that share insights and resources at GrowthHackers.com, as well as a collaborative software platform, NorthStar by GrowthHackers, that keeps teams on the same page as they accelerate their growth testing and learning process.</p>
