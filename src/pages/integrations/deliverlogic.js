...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/deliverlogic.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        DeliverLogic Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(7, 115, 184, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">DeliverLogic is an industry leading logistics platforms designed to support Restaurant Delivery services, local restaurants, and other logistics and delivery services.</p>
