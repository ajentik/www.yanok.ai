...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/social-intents.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Social Intents lets you live chat with your customers in real-time to provide exceptional service.</p>
  ...
  <div>Triggers when a chat is closed by an agent.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new offline message is received.</div>
</div>
