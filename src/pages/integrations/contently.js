...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Contently"
      description={`Contently offers the platform, freelance talent, and strategic services you need to create content that builds trust and drives results.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Contently offers the platform, freelance talent, and strategic services you need to create content that builds trust and drives results.`} />
        </>
      ),
    },
  };
