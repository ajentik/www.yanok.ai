...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/propeller-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Propeller CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">A powerful, minimalist CRM tool designed for sales and marketing teams to work directly inside Gmail and Google Suite. Manage emails and contacts directly inside your inbox.</p>
