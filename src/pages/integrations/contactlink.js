...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/contactlink.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ContactLink Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(98, 1, 237, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ContactLink puts all your communication options at one link: video call, video message, calendar, call, text, email.</p>
