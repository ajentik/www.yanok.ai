...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/okta.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Okta Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 124, 194, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Okta helps companies manage and secure user authentication into modern applications, and for developers to build identity controls into applications, website web services and into devices.</p>
  ...
  <div>Creates a user without credentials, and sends them an e-mail with an account creation prompt.</div>
</div>
