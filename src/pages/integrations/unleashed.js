...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/unleashed.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Through its 3 mobile brands Mobile Vikings, JIM Mobile and Stievie, the goal at Unleashed is to provide an answer to all your mobile needs.</p>
