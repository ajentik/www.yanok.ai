...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/serwersms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SerwerSMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(217, 18, 24, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SerwerSMS is a Polish mobile marketing platform which provides bulk SMS, MMS & VMS VOICE services.</p>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Add Blacklisted Phone Number</div>
  <div>Adds a phone number to the blacklist.</div>
</div>
