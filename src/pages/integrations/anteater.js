...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/anteater.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        AntEater Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(33, 150, 243, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">AntEater helps teams on Gmail, Outlook and Slack keep track of activity with prospects, customers, vendors & partners with AI.</p>
