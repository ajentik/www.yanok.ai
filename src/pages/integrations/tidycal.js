...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tidycal.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TidyCal Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(13, 110, 253, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TidyCal is simple and easy calendar management and booking tool.</p>
