...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/landing-page-robot-by-marcom-rob.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Landing Page Robot by Marcom Robot Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(145, 101, 247, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Landing Page Robot is a landing page builder designed for teams creating landing pages at scale.</p>
