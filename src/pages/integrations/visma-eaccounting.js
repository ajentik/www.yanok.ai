...
export default function Page() {
  return (
    <IntegrationLayout 
      ...
      description={`Visma eAccounting is a financial software for small and medium sized businesses.`}
    >
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content={`Visma eAccounting is a financial software for small and medium sized businesses.`} />
        </>
      ),
    },
  };
