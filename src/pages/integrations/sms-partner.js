...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sms-partner.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SMS Partner Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(40, 192, 195, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The "SMS Partner" module proposes to effect SMS mailings automatically. You create your account, you integrate your automation and go!</p>
