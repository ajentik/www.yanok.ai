...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/botmother.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Botmother Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Wordpress for chat bots. Botmother helps to collect useful business bots for 1 day for several instant messengers without programming in the visual editor.</p>
