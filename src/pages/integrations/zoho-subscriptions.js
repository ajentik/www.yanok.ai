...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zoho-subscriptions.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Zoho Subscriptions Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(209, 232, 253, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Zoho Subscriptions is a recurring billing and subscription management app that helps manage the entire life cycle of your customers - from billing and charging to managing their subscriptions.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Subscription Downgrade</div>
  <div>Triggers when a subscription is downgraded.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Payment Failure</div>
  <div>Triggers when there is an error in processing payment.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a subscription is renewed.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Payment Success</div>
  <div>Triggers when a payment is received successfully.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Subscription Upgrade</div>
  <div>Triggers when a subscription is upgraded.</div>
</div>
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Record Payment</div>
  <div>Make payment to an Invoice.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Search an existing customer.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Invoice</div>
  <div>Lookup an existing invoice.</div>
</div>
