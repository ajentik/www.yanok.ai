...
export default function Page() {
  return (
    <IntegrationLayout 
      title="Pluvo"
      description={`Pluvo is an all-in-one learning platform that lets you create beautiful online courses that leave an unforgettable impression. For every budget and every learning challenge.`}
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>Pluvo</title>
          <meta name="description" content={`Pluvo is an all-in-one learning platform that lets you create beautiful online courses that leave an unforgettable impression. For every budget and every learning challenge.`} />
        </>
      ),
    },
  };
