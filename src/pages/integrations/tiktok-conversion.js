...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tiktok-conversion.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TikTok Conversions Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Send important customer events directly from your server or CRM to TikTok Event API, allowing you to better optimize for ad performance.</p>
  ...
  <div>Send lead events to TikTok for further ad delivery optimization</div>
</div>
