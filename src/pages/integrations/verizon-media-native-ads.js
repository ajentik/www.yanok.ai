...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/verizon-media-native-ads.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Verizon Media Native Ads Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(205, 4, 11, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Verizon Media Native Ads combines the power of content, scale and data to create smarter marketing solutions that build stronger relationships with consumers.</p>
  ...
  <div>Creates a new csv report file.</div>
</div>
