...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/crosstrax.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        CROSStrax Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(196, 32, 51, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">CROSStrax is case management system for investigator to organize all investigation related stuff and more within single platform.</p>
  ...
  <div>Triggers when a new case generated.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Client</div>
  <div>Triggers when new client added.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new invoice generated.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Case Note</div>
  <div>Triggers when new note added on case.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds a client when creating a new case</div>
</div>
