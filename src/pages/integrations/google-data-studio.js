...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/google-data-studio.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Google Data Studio allows you to create branded reports with data visualizations to share with your clients.</p>
