...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/sevdesk.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">sevDesk is the personal CFO for small businesses. It will help you to do accounting, banking, invoicing and will give you real time insights</p>
