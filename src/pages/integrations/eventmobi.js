...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/eventmobi.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        EventMobi Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 184, 28, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">EventMobi’s event management platform has been trusted by associations, agencies and corporations to deliver engaging professional events for 12+ years</p>
  ...
  <div>Creates a company in an event.</div>
</div>
