...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/post-my-link.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Post My Link Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 103, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Post My Link is an advanced URL short-link service for individuals and collaborative teams.</p>
