...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/boberdoo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Boberdoo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">A SaaS company that offers lead capture software for companies that sell leads. Track, route and bill for all of your web leads & calls in one platform regardless of vertical.</p>
