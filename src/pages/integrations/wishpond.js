...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/wishpond.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Wishpond Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(27, 95, 130, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Wishpond is a lead generation and marketing automation platform that helps customers to manage and nurture their leads.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Event on Lead</div>
  <div>Triggers when a chosen lead performs an event or activity.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Lead on List</div>
  <div>Triggers when a new lead is added to a chosen list.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div class="flex flex-col items-center mt-20">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Add Lead Properties</div>
  <div>Add properties to a lead.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Add Lead to List</div>
  <div>Add an existing lead to a chosen list.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Remove a lead from a chosen list.</div>
</div>
