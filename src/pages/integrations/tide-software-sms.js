...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/tide-software-sms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Tide Software SMS Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(90, 56, 137, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Tide Software SMS is an SMS platform to message your customers automatically with full control, message customization, phishing protection, and more.</p>
