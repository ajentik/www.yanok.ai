...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/evolution-forms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Evolution Forms Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(58, 87, 195, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Evolution Forms is a form designer focused on lead generation and speed.</p>
