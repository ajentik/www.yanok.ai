...
export default function Page() {
  return (
    <IntegrationLayout 
      title="4iiz"
      description="4iiz is a system that optimizes every vertical within a law firm."
    >
  ...
  return {
    props: {
      metaTags: (
        <>
          <title>4iiz</title>
          <meta name="description" content="4iiz is a system that optimizes every vertical within a law firm." />
        </>
      ),
    },
  };
