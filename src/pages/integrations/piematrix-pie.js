...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/piematrix-pie.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        PieMatrix Pie Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(81, 167, 249, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Pie is a visual process and project management web application that combines agile with waterfall and made for repeatable project processes. Pie is designed for improving end-project results with team collaboration.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an existing task is updated.</div>
</div>
