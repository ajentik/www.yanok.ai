...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/museai.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        muse.ai Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">muse.ai is a complete video hosting and streaming platform with a clean interface, sharing, embedding, and advanced video search.</p>
  ...
  <div>Triggers when a new video is uploaded.</div>
</div>
  ...
  <div>Uploads a video or audio file.</div>
</div>
