...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/smarty-accounting.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Smarty Accounting Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(106, 27, 154, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Smarty Accounting is a comprehensive accounting and invoicing software for SMEs. The platform can monitor your ban account and remind clients about overdue payments, minimising the amount of accounting work you do.</p>
