...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/paymo.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Paymo Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(76, 173, 40, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Simple online project management application that bundles task management, time tracking and invoicing</p>
  ...
  <div>Triggers when a new client is created in Paymo.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Client Contact</div>
  <div>Triggers when a new client contact is created in Paymo.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Invoice</div>
  <div>Triggers when a new invoice is created in Paymo.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new report is created in Paymo.</div>
</div>
