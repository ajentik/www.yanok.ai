...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/shopvox.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Shopvox Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">shopVOX is a web-based job management, CRM, and POS system built for its users’ custom shops and industries.</p>
