...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/parse.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Parse makes it easy to add a backend to mobile apps and much, much more. It talks simple JSON but is extremely powerful and therefore very flexible.</p>
