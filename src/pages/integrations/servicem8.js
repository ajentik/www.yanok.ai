...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/servicem8.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ServiceM8 Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(125, 200, 54, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ServiceM8 is a field service app and small business management platform for your computer, iPhone and iPad. Track staff locations, navigate to jobs, and control your estimates, invoicing, scheduling, safety reports, clients & more.</p>
  ...
  <div>Triggers when a Job\'s status changes to Completed.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Job Queued</div>
  <div>Triggers when a Job is assigned to a Queue.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a Form is completed. Requires the Forms add-on to be enabled in your ServiceM8 account.</div>
</div>
