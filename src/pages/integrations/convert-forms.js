...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/convert-forms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Convert Forms Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(244, 180, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Convert Forms is a user-friendly form builder for Joomla that allows you to easily create perfect contact forms, newsletter opt-in forms and any kind of forms so you can collect the data and registrations in your Joomla website.</p>
