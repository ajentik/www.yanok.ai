...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/taleo.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Taleo Corporation is a provider of cloud-based talent management solutions, enabling businesses to recruit eligible candidates.</p>
