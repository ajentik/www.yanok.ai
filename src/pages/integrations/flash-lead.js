...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/flash-lead.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Flash Lead Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(64, 132, 244, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Flash lead is a sales management and a Revenue growth software on a mission to help sales people close more deals in less time; its features varies from lead management, VoIP, Omni channel conversations and more all available in Mobile and Web App.</p>
  ...
  <div class="font-semibold">Send Lead</div>
  <div>Save new lead data to flashlead CRM.</div>
</div>
