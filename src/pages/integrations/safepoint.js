...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/safepoint.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Safepoint Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(11, 0, 40, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Safepoint is a lone worker safety platform to keep your workers safe.</p>
