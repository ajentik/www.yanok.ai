...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/floify.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Floify\'s mortgage automation and point-of-sale software solution streamlines and organizes the loan origination process for lenders and borrowers alike.</p>
