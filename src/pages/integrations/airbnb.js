...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/airbnb.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Airbnb Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 90, 95, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Airbnb is a unique marketplace for renting amazing lodging in over 190 different countries. Use Zapier\'s Email Parser to take confirmation emails and send them to hundreds of different SaaS apps!</p>
