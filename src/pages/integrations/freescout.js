...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/freescout.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        FreeScout Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 120, 215, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">FreeScout is the super lightweight free open source helpdesk and shared inbox built with PHP.</p>
