...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/actito.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Actito offers a suite of relationship marketing tools to create a meaningful dialogue with prospects and clients.</p>
