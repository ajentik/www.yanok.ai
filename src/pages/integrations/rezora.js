...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/rezora.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        rezora Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 193, 54, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Rezora is a digital marketing platform for real estate marketing managers and agents to market their companies, themselves and listings.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an existing contact by email address.</div>
</div>
