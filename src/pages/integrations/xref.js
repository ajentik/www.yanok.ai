...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/xref.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Use Xref\'s online reference checking platform to gather valuable candidate insights quickly and with ease.</p>
