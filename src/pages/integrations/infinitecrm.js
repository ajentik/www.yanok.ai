...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/infinitecrm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        InfiniteCRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(34, 195, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">InfiniteCRM is a CRM platform designed to meet the needs of different business areas, from sales force to marketing, customer care to call centre. InfiniteCRM boosts your business by creating winning, enduring relationships with leads, prospects, customers and partners.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Update Activity</div>
  <div>Update an existing Activity</div>
</div>
