...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/leadboxer.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        LeadBoxer Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(21, 63, 145, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Generate B2B sales leads from your online data. We analyse your online data in realtime and show you the businesses who visited your site. Score, rank, filter your leads and contact them.</p>
  ...
  <div>Triggers when a new lead has been identified.</div>
</div>
