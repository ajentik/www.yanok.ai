...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/symphony.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Symphony Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(68, 179, 221, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Symphony is a communications platform that securely connects markets and individuals, promoting collaboration and increasing productivity while maintaining organizational compliance.</p>
  ...
  <div>Sends a message to a chat room.</div>
</div>
