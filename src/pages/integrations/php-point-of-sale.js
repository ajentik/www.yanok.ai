...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/php-point-of-sale.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        PHP Point Of Sale Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(51, 122, 183, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">PHP Point Of Sale is an easy to use Web Based Point Of Sale System for Retail. Helps with inventory tracking, sales tax, and managing all aspects of your retail business.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Receiving</div>
  <div>Triggers when a new receiving is created.</div>
</div>
