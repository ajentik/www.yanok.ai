...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/actsoft.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Actsoft Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Actsoft is the leading provider of mobile applications for businesses with workers in the field. Scalable and Affordable, with Award Winning Customer Care!</p>
