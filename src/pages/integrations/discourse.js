...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/discourse.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Discourse is an open source discussion platform used as a mailing list, discussion forum, long-form chat room, and more.</p>
