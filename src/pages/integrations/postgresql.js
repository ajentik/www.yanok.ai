...
export default function Page() {
  return (
    <IntegrationLayout 
      title="PostgreSQL"
      description="PostgreSQL is a powerful, open-source database engine with a uniquely advanced query optimizer and dozens of built in features, making it an easy choice for production databases."
    >
      <div dangerouslySetInnerHTML={{ __html: `<div class="flex flex-col items-center pt-10">
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/postgresql.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        PostgreSQL Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(51, 103, 145, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">PostgreSQL is a powerful, open-source database engine with a uniquely advanced query optimizer and dozens of built in features, making it an easy choice for production databases.</p>
    ...
    props: {
      metaTags: (
        <>
          ...
          <meta name="description" content="PostgreSQL is a powerful, open-source database engine with a uniquely advanced query optimizer and dozens of built in features, making it an easy choice for production databases." />
        </>
      ),
    },
  };
