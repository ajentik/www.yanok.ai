...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/realvuu.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        RealVuu Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(47, 122, 184, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">RealVuu is a real estate platform that helps promoters fill their empty units</p>
