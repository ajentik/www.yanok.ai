...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/nvite.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">nvite is an attendee-focused, online event ticketing and registration platform that helps easily organize and manage events.</p>
