...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/halp.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Halp Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(132, 94, 247, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Halp is a conversational ticketing solution for operations teams to assign, prioritize, and answer requests from Slack in a message-based interface.</p>
