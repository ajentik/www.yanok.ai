...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zipform-plus.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        zipForm Plus Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(44, 99, 134, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">For more than 20 years, zipForm® — zipLogix\'s real estate forms software and the exclusive and official forms software for NAR — has been the real estate industry\'s technology foundation. zipLogix offers products that support more than 640,000 users, and delivers innovative products and web applications that significantly improve the productivity and efficiency and address the specific needs of REALTORS®.</p>
  ...
  <div>Triggers when a new contact is added to a zipForm Address Book.</div>
</div>
  ...
  <div>Creates a new zipForm Plus contact.</div>
</div>
