...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/active-directory.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Microsoft\'s Active Directory is a directory service often bundled with Microsoft Windows Server operating systems or as a part of Azure hosting. It is an interface for user authentication and identity as well as a device (like computers or printers) registration.</p>
