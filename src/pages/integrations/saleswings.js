...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/saleswings.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        SalesWings Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">SalesWings enables your team to constantly engage into more timely, and fully personal conversations thanks to real-time insights into your leads\' interest, priorities, and profile.</p>
