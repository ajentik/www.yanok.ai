...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/ninjaforms.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Ninja Forms Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(239, 71, 72, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Ninja Forms is the easiest and most flexible WordPress Form builder.</p>
