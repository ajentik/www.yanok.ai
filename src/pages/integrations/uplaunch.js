...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/uplaunch.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        UpLaunch Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 162, 86, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">UpLaunch is a CRM and marketing automation platform built specifically for the fitness industry.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Find a contact by Email Address.</div>
</div>
