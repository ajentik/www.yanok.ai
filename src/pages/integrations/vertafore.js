...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/vertafore.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Vertafore Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Vertafore provides insurance software solutions for independent agencies and brokers, MGAs, and carriers, helping them better manage their businesses.</p>
