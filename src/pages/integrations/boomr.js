...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/boomr.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Boomr\'s employee time tracking, timesheets, and time clock app makes it easy to accurately track & manage your workforce, payroll & more.</p>
