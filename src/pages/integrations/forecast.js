...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/forecast.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Forecast Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(110, 15, 234, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Forecast is a full-suite business platform that enables professional service organizations to run efficiently and predictably in one AI-powered software.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Search for project by name.</div>
</div>
