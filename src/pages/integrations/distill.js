...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/distill.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Distill monitors websites and feeds to track changes. It can send notifications in form of sound, popup, email, sms and more!</p>
