...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/the-studio-director.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        The Studio Director Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">The most complete dance studio software online. We make running your studio simple, easy, and rewarding by catering our software to your exact business needs.</p>
