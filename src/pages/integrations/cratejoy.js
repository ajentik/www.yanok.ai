...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/cratejoy.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Cratejoy Inc. operates an online platform that enables users to build their own subscription business.</p>
