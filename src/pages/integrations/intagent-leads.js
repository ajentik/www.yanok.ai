...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/intagent-leads.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        INTAGENT Leads Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(173, 25, 27, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Intagent provides real estate web design and CRM lead management for agents, brokers, and companies.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Get Intagent Leads</div>
