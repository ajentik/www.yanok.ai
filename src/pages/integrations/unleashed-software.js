...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/unleashed-software.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">UnleashedSoftware is a world class online inventory management software for small, medium and large business which integrates closely with Xero.</p>
