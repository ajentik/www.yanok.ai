...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/nexticy.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Nexticy Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(66, 139, 219, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Nexticy is the most innovative form builder that helps you create paper-like forms and documents. With Nexticy you can make your work paperless and become more productive with just an iPad.</p>
  ...
  <div>Triggers when you get a new response.</div>
</div>
