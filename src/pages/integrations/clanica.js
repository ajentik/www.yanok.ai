...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/clanica.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Clanica Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(101, 92, 151, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Clanica is a robust email delivery service, equipped with an easy to use SMTP service and Email API, enabling you and your business to send all kinds of emails, from transactional to newsletter and marketing emails.</p>
  ...
  <div>This action sends an email using Clanica API.</div>
</div>
