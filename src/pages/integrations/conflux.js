...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/conflux.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Conflux Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 0, 0, 0)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Conflux is an online application that lets you collect feedback, organize it into ideas and communicate those ideas back to your customers so you can collect more feedback.</p>
