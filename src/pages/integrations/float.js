...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/float.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Float Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(26, 144, 220, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Float is the fast and friendly resource scheduling app. Keep track of who\'s working on what and when.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Logged Time</div>
  <div>Triggers when a new logged time is created.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a new time off is created.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Logged Time</div>
  <div>Triggers when a logged time is modified.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new department.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Create Logged Time</div>
  <div>Creates a new logged time.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Creates a new time off.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Logged Time</div>
  <div>Update an existing logged time entry by ID.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Update Task</div>
  <div>Update an existing task by ID.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Logged Time</div>
  <div>Finds a logged time by ID.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Find or Create Logged Time</div>
  <div>Finds a logged time by ID.</div>
</div>
