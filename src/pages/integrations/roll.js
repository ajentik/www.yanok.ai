...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/roll.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Roll Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 126, 229, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Roll is a platform with everything your business needs in one place. Manage projects, track sales, understand and grow your business.</p>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">New Time Record</div>
  <div>Triggers when a new time record is created.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Time Record</div>
  <div>Creates a new time record.</div>
</div>
