...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/twentythree-personal.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        TwentyThree Personal Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(30, 201, 91, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">TwentyThree Personal is a video marketing platform with comprehensive capabilities to engage your audience, create an on-brand experience, scale to fit you as you grow and provide analytics to help you drive better results.</p>
  ...
  <div class="font-semibold">Create Personal Video Task</div>
  <div>Creates Personal video task</div>
</div>
