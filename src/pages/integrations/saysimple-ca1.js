...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/saysimple-ca1.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Saysimple Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 102, 0, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Saysimple is an omni-channel customer communications platform, built to leverage digital customer service from one single workspace.</p>
  ...
  <div>Triggers when receiving a new inbound message.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Send a message via the Saysimple Platform</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contact</div>
  <div>Find a contact based on their unique identifier.</div>
</div>
