...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/zipperagent.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        ZipperAgent Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(0, 150, 136, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">ZipperAgent is all-in-one Solution for Real Estate Professionals. It is a platform designed exclusively for Real Estate Offices, Brokers and Agents, to run their marketing, sales, and transactions easily from a single cloud based application and smartphones.</p>
  ...
  <div>Create Contact - Creates a contact.</div>
</div>
