...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/microsoft-dynamics-crm.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Microsoft Dynamics 365 CRM Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(255, 255, 255, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Microsoft Dynamics is built for any device, anywhere. Built for you. For Dynamics Version 9 and Dynamics 365.</p>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a contact has been updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when a lead has been updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Triggers when an opportunity has been updated.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an account by name.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Contact</div>
  <div>Finds a contact by email address or other searchable field.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Lead</div>
  <div>Finds a lead by email address or other searchable field.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Find Opportunity</div>
  <div>Finds an opportunity by subject or other searchable field.</div>
</div>
...
<div class="flex flex-col items-start">
  ...
  <div>Finds an opportunity by subject or other searchable field, or creates the opportunity if it does not exist.</div>
</div>
