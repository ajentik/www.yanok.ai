...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/greenrope.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        GreenRope Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(143, 206, 59, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Small business marketing software providing powerful and easy to use CRM, email marketing, and social media integration.</p>
