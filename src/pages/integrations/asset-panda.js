...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/asset-panda.png" />
  ...
  <p class="max-w-3xl mt-8 text-center">Asset Panda tracks and manages assets with reporting, alerts, workflows, and iOS/Android/desktop apps to track anything, anywhere, anytime.</p>
