...
export default function Page() {
  ...
  <div class="flex flex-row gap-12">
    <img class="size-20" src="/assets/images/integrations/office-365.png" />
    <div class="flex items-center justify-between grow">
      <h1>
        Microsoft Office 365 Integrations
        <span class="block max-w-full h-0.5" style="background-color: rgba(234, 62, 35, 1)"></span>
      </h1>
    </div>
  </div>
  <p class="max-w-3xl mt-8 text-center">Microsoft Office 365 Business is a complete office suite in the cloud. It provides all the standard office products like Excel, Outlook, Word, SharePoint and more, but available from any internet enabled computer! Zapier does not currently support Outlook.com addresses or Home 365 accounts, only business or Enterprise.</p>

  <div class="flex flex-col items-center mt-20">
    <h2 class="text-2xl font-bold">Triggers</h2>
    <div class="flex flex-col gap-5">
      <div class="flex flex-col items-start">
  <div class="font-semibold">Calendar Event Start</div>
  <div>Triggers at a specified time before an event in your calendar starts.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Calendar Event</div>
  <div>Triggers when a new event is created in your calendar.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Contact</div>
  <div>Triggers when a new contact is added to your account</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">New Email</div>
  <div>Triggers when a new e-mail is received in your inbox.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Updated Calendar Event</div>
  ...
  <div>Create an event in the calendar of your choice.</div>
</div>
...
<div class="flex flex-col items-start">
  <div class="font-semibold">Create Draft Email</div>
  <div>Creates a draft of an email that can then be reviewed and sent out.</div>
</div>

<div class="flex flex-col items-start">
  <div class="font-semibold">Send Email</div>
  <div>Send an email from your Office 365 account.</div>
</div>
