...
export default function Page() {
  return (
    ...
    >
      <div dangerouslySetInnerHTML={{ __html: `# Cybersecurity Solutions Powered by Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Cybersecurity Solutions Powered by Yanok Platform</title>
          <meta name="description" content="Enhance your organization's cybersecurity with Yanok's AI-driven platform, offering advanced threat detection, vulnerability assessment, and incident response capabilities." />
        </>
      ),
    },
  };
