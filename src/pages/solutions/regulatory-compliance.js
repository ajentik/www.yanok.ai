...
export default function Page() {
  return (
    <SolutionsLayout 
      ...
      description=""
    >
      <div dangerouslySetInnerHTML={{ __html: `# Regulatory and Compliance Solutions on Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Regulatory and Compliance Solutions on Yanok Platform</title>
