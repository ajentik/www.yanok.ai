...
export default function Page() {
  return (
    <SolutionsLayout 
      ...
      description=""
    >
      <div dangerouslySetInnerHTML={{ __html: `# Legal Industry Use Cases and Solutions run on Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Legal Industry Use Cases and Solutions run on Yanok Platform</title>
