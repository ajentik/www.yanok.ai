...
export default function Page() {
  return (
    ...
    >
      <div dangerouslySetInnerHTML={{ __html: `# Advanced AI Solutions Powered by Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Advanced AI Solutions Powered by Yanok Platform</title>
          <meta name="description" content="Explore advanced AI solutions with Yanok's platform, offering capabilities in predictive maintenance, intelligent automation, and more." />
        </>
      ),
    },
  };
