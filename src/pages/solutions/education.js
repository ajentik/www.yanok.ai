...
export default function Page() {
  return (
    ...
    >
      <div dangerouslySetInnerHTML={{ __html: `# Education Solutions Powered by Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Education Solutions Powered by Yanok Platform</title>
          <meta name="description" content="Revolutionize learning experiences with Yanok's AI-driven platform, offering personalized content generation, automated essay scoring, adaptive learning paths, and efficient administration tools." />
        </>
      ),
    },
  };
