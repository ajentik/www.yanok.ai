...
export default function Page() {
  return (
    <SolutionsLayout 
      ...
      description=""
    >
      <div dangerouslySetInnerHTML={{ __html: `# Human Resources Use Cases and Solutions run on Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Human Resources Use Cases and Solutions run on Yanok Platform</title>
