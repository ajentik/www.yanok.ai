...
export default function Page() {
  return (
    ...
    >
      <div dangerouslySetInnerHTML={{ __html: `# Financial Services Solutions Powered by Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Financial Services Solutions Powered by Yanok Platform</title>
          <meta name="description" content="Optimize your financial services with Yanok's AI-driven platform, offering AI-driven credit scoring, intelligent client onboarding, AI client profiling, and unstructured data analysis for market insights." />
        </>
      ),
    },
  };
