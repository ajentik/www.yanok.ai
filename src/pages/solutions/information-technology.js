...
export default function Page() {
  return (
    <SolutionsLayout 
      ...
      description=""
    >
      <div dangerouslySetInnerHTML={{ __html: `# Information Technology Use Cases and Solutions run on Yanok Platform
...
export async function getStaticProps() {
  return {
    props: {
      metaTags: (
        <>
          <title>Information Technology Use Cases and Solutions run on Yanok Platform</title>
